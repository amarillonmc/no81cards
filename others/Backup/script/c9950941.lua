...
function c9950941.initial_effect(c)
	...
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_DISABLE_SUMMON)
...
function c9950941.cfilter2(c)
	return c:IsLevel(7,8,2) and c:IsSetCard(0xba5) and not c:IsCode(9950941) and c:IsAbleToRemoveAsCost()
end
function c9950941.spcost2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToRemoveAsCost()
		and Duel.IsExistingMatchingCard(c9950941.cfilter3,tp,LOCATION_GRAVE+LOCATION_HAND,0,1,nil,ATTRIBUTE_LIGHT+ATTRIBUTE_DARK)
		and Duel.IsExistingMatchingCard(c9950941.cfilter2,tp,LOCATION_GRAVE+LOCATION_HAND,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g1=Duel.SelectMatchingCard(tp,c9950941.cfilter3,tp,LOCATION_GRAVE+LOCATION_HAND,0,1,1,nil,ATTRIBUTE_LIGHT+ATTRIBUTE_DARK)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g2=Duel.SelectMatchingCard(tp,c9950941.cfilter2,tp,LOCATION_GRAVE+LOCATION_HAND,0,1,1,nil)
	g1:Merge(g2)
