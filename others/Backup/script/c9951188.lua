...
function c9951188.initial_effect(c)
  ...
  --to hand
	...
	c:RegisterEffect(e1)
  --ritual summon
	local e2=aux.AddRitualProcGreater2(c,c9951188.filter,LOCATION_HAND+LOCATION_DECK)
	e2:SetDescription(aux.Stringid(9951188,1))
	e2:SetType(EFFECT_TYPE_QUICK_O)
	e2:SetRange(LOCATION_MZONE)
	e2:SetHintTiming(0,TIMINGS_CHECK_MONSTER+TIMING_MAIN_END)
	e2:SetCountLimit(1,9951188)
	e2:SetCondition(c9951188.rscon)
 --to hand
...
function c9951188.filter(c,e,tp,chk)
	return c:IsSetCard(0xba5)
end
function c9951188.rscon(e,tp,eg,ep,ev,re,r,rp)
