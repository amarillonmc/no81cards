...
function c9981608.cfilter0(c)
	return c:GetAttack()>0 and c:IsAbleToRemoveAsCost()
end
function c9981608.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c9981608.cfilter0,tp,0,LOCATION_MZONE,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c9981608.cfilter0,tp,0,LOCATION_MZONE,1,1,nil)
