...
--destroy & damage
	...
	e2:SetDescription(aux.Stringid(9951034,0))
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetCountLimit(1)
	e2:SetRange(LOCATION_MZONE)
	e2:SetTarget(c9951034.target2)
	e2:SetOperation(c9951034.operation2)
	c:RegisterEffect(e2)
	 --spsummon bgm
...
function c9951034.target2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c9951034.operation2(e,tp,eg,ep,ev,re,r,rp)
