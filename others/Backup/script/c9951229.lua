...
function c9951229.sprfilter(c)
	return c:IsSetCard(0x6bd2,0xcbd2) and c:IsType(TYPE_MONSTER) and c:IsAbleToRemoveAsCost()
end
...
function c9951229.atktg(e,c)
	return c==Duel.GetAttacker() and c:IsSetCard(0x6bd2,0xcbd2)
end
function c9951229.spfilter(c,e,tp)
	return c:IsSetCard(0x6bd2,0xcbd2) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c9951229.filter(c)
	return c:IsFaceup() and c:IsLocation(LOCATION_MZONE) and c:IsSetCard(0x6bd2,0xcbd2)
end
