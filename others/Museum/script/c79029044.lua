...
function c79029044.spcon(e,c)
	...
	return g:CheckSubGroup(c79029044.fselect,2,2,tp) and (c:IsLocation(LOCATION_HAND) or (c:IsLocation(LOCATION_GRAVE) and Duel.IsPlayerAffectedByEffect(tp,79029451)))
end
