...
function cm.initial_effect(c)
	...
	return c:IsCode(79844764) and c:IsAbleToHand()
end
	...
	return c:IsAttackAbove(2400) and c:IsDefense(1000) and c:IsAttribute(ATTRIBUTE_WIND) and c:IsSummonable(true,nil)
end
