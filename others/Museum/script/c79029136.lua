...
function c79029136.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(79029136,4))
	...
	e2:SetDescription(aux.Stringid(79029136,5))
	...
	e3:SetDescription(aux.Stringid(79029136,6))
...
function c79029136.atop(e,tp,eg,ep,ev,re,r,rp)
	...
	Debug.Message("去吧！")
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029136,0))
	local e1=Effect.CreateEffect(c)
...
function c79029136.atkop(e,tp,eg,ep,ev,re,r,rp) 
	local c=e:GetHandler()  
	Debug.Message("哒哒哒哒哒！")
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029136,1))
	--trible atk
	local e4=Effect.CreateEffect(c)
...
function c79029136.disop(e,tp,eg,ep,ev,re,r,rp) 
	local c=e:GetHandler() 
	Debug.Message("猎物快停下！")
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029136,2))
	--disable field
	local e4=Effect.CreateEffect(c)
...
function c79029136.damop(e,tp,eg,ep,ev,re,r,rp)
	Debug.Message("对付他们只要砰！啪！两下就好啦。")
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029136,3))
