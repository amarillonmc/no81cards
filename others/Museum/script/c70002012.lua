...
function cm.initial_effect(c)
	--code
	aux.EnableChangeCode(c,70002010,LOCATION_MZONE+LOCATION_GRAVE)
	c:SetUniqueOnField(1,1,70002010)
	--MoveToField
	...
	Debug.Message("三军将才可为帅，东吴水师我为锋。")
	Debug.Message("吾激流独进，善建首功。")   
end
