...
function c79029123.lzop(e,tp,eg,ep,ev,re,r,rp)
	...
	Debug.Message("大家跟紧我，可别走丢了。")
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029123,0))
	local g1=Duel.GetMatchingGroup(c79029123.spfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,nil,e,tp,att)
	Duel.BreakEffect()
...
function c79029123.activate(e,tp,eg,ep,ev,re,r,rp)
	Debug.Message("别想前进一步！")
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029123,2))
...
function c79029123.activate1(e,tp,eg,ep,ev,re,r,rp)
	Debug.Message("别想前进一步！")
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029123,1))
