...
function c115682705.cfilter(c)
    return c:IsSetCard(0x10b4) and not c:IsPublic()
end
...
function c115682705.filter(c)
    return c:IsSetCard(0x10b4) and c:IsType(TYPE_MONSTER) and not c:IsType(TYPE_RITUAL) and c:IsAbleToHand()
end
