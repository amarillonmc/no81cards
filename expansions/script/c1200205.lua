...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	elseif Duel.IsExistingMatchingCard(s.thfilter,tp,LOCATION_DECK,0,1,nil)
...
function s.rtop(e,tp,eg,ep,ev,re,r,rp)
	...
	--Debug.Message(1)
	s.PlayerHint(e,tp,8)
	Duel.RegisterFlagEffect(tp,supercode,RESET_PHASE+PHASE_END,0,2)
