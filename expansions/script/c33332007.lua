...
local m=33332007
local cm=_G["c"..m]
function c33332007.initial_effect(c)
	--Activate
...
function cm.filter2(c,e,tp,mc,rk)
	return c:IsRank(rk) and c:IsSetCard(0x5567) and mc:IsCanBeXyzMaterial(c)
...
function cm.thfilter(c)
	return c:IsSetCard(0x5567) and c:IsType(TYPE_MONSTER) and c:IsAbleToRemoveAsCost()
end
