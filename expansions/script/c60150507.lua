...
function c60150507.thfilter(c,e,tp)
	return c:IsSetCard(0xab20) and not c:IsCode(60150507) and c:IsType(TYPE_MONSTER) and c:GetLevel()<=4 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c60150507.thfilter2(c,e,tp)
	return c:IsSetCard(0xab20) and not c:IsCode(60150507) and c:IsType(TYPE_MONSTER) and c:GetLevel()<=10 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
