...
function c22021020.initial_effect(c)
	...
	e2:SetCost(c22021020.tdcost)
	e2:SetTarget(c22021020.destg)
	e2:SetOperation(c22021020.desop)
	c:RegisterEffect(e2)
	--destroy
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(22021020,4))
	e3:SetCategory(CATEGORY_DESTROY)
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetRange(LOCATION_MZONE)
	e3:SetCondition(c22021020.erecon)
	e3:SetCost(c22021020.tdcost1)
	e3:SetTarget(c22021020.destg)
	e3:SetOperation(c22021020.desop)
	c:RegisterEffect(e3)
end
...
function c22021020.erescon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22021020.tdcost1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c22021020.filter,tp,LOCATION_HAND,0,1,nil) end
	Duel.DiscardHand(tp,c22021020.filter,1,1,REASON_COST+REASON_DISCARD)
	Duel.SelectOption(tp,aux.Stringid(22021020,2))
