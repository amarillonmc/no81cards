...
function s.filter1(c,e,tp)
	return c:IsRank(4) and c:IsSetCard(0x5ce1) and c:IsType(TYPE_XYZ) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
...
function s.filter2(c,e,tp,mc)
	...
	return c:IsRank(5) and c:IsSetCard(0x6ce1) and c:IsType(TYPE_XYZ) and mc:IsCanBeXyzMaterial(c)
