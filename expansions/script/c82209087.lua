...
function cm.initial_effect(c)
	...
	e3:SetCategory(CATEGORY_TOHAND+CATEGORY_COIN+CATEGORY_SEARCH)  
...
function cm.thtg(e,tp,eg,ep,ev,re,r,rp,chk)  
	...
	if chk==0 then return Duel.GetFieldGroupCount(tp,0,LOCATION_DECK)>2 and g:FilterCount(Card.IsAbleToHand,nil)>0 end  
