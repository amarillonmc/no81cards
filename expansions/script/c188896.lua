...
function cm.initial_effect(c)   
	...
	e1:SetCountLimit(1,188896) 
	e1:SetTarget(c188896.thtg) 
	e1:SetOperation(c188896.thop) 
	c:RegisterEffect(e1)  
	local e2=e1:Clone() 
...
function c188896.thfil(c) 
	return c:IsAbleToHand() and c:IsSetCard(0xca6) and c:IsType(TYPE_MONSTER) and not c:IsCode(188896) 
end 
function c188896.thtg(e,tp,eg,ep,ev,re,r,rp,chk) 
	if chk==0 then return Duel.IsExistingMatchingCard(c188896.thfil,tp,LOCATION_DECK,0,1,nil) end 
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK) 
end 
function c188896.thop(e,tp,eg,ep,ev,re,r,rp) 
	local c=e:GetHandler() 
	local g=Duel.GetMatchingGroup(c188896.thfil,tp,LOCATION_DECK,0,nil) 
