...
function c82557935.filter1(c,e,tp)
	return c:IsFaceup() and c:IsType(TYPE_XYZ) and c:IsSetCard(0x829)
		and Duel.IsExistingMatchingCard(aux.NecroValleyFilter(c82557935.filter2),tp,LOCATION_GRAVE,LOCATION_GRAVE,1,c)
end
...
function c82557935.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c82557935.filter2),tp,LOCATION_GRAVE,LOCATION_GRAVE,1,1,tc,e)
