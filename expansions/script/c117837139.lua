function c117837139.initial_effect(c)
    ...
    e1:SetCondition(c117837139.spcon)
    e1:SetOperation(c117837139.spop)
    c:RegisterEffect(e1)
...
function c117837139.spcon(e,c)
    if c==nil then return true end
    local tp=c:GetControler()
    return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.GetLocationCountFromEx(1-tp,tp,nil,c)>0 and Duel.IsExistingMatchingCard(c117837139.sumfilter,tp,LOCATION_HAND,0,1,nil,e,tp) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
function c117837139.spop(e,tp,eg,ep,ev,re,r,rp,c)
