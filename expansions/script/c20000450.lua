...
function fu_Abyss.Hand_Open(c,op)
	...
	e2:SetTarget(fu_Abyss.HO_tg)
	c:RegisterEffect(e2)
	return e1,e2
end
function fu_Abyss.HBO_cos(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e:GetHandler():RegisterFlagEffect(m,RESET_EVENT+RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,nil,66)
end
function fu_Abyss.HO_con(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPublic()
end
function fu_Abyss.HO_tg(e,c,sump,sumtype,sumpos,targetp,se)
...
function cm.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	if v then Duel.SendtoGrave(v,REASON_EFFECT) end
end
--e2
...
function cm.op2(e,tp,eg,ep,ev,re,r,rp)
	...
	local v=Duel.GetMatchingGroup(cm.opf2,tp,LOCATION_GRAVE,0,nil):GetMaxGroup(Card.GetBaseAttack)
