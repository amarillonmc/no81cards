...
function s.filter1(c)
	return c:IsFaceup() and c:IsSetCard(0x3a76) and not c:IsCode(12825710)
end
function s.filter2(c)
	return c:IsCode(12825710)
end
...
function s.cfilter(c)
	return c:IsFaceup() and c:IsCode(12825710)
end
