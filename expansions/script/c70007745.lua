...
function cm.initial_effect(c)
	...
	return c:IsSetCard(0x1275) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
...
function cm.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:IsCode(40139997) and c:IsCanBeSpecialSummoned(e,0,tp,true,true,POS_FACEUP)
end
