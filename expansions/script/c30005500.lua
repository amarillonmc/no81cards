...
function cm.tgfilter(c)
	return  c:IsSetCard(0x927) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave()
end
...
function cm.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,cm.tgfilter,tp,LOCATION_EXTRA+LOCATION_DECK,0,1,1,nil)
