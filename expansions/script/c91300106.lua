...
function s.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g1=Duel.GetMatchingGroup(s.costfilter,tp,LOCATION_HAND,0,e:GetHandler())
	...
	local g=Duel.SelectTarget(tp,aux.TRUE,tp,0,LOCATION_MZONE,1,e:GetValue(),nil)
end
