...
function cm.initial_effect(c)
	...
	c:RegisterEffect(e0)
	--the immune effect is already removed 
...
function cm.con(e,tp,eg,ep,ev,re,r,rp)  
	return Duel.GetFieldGroupCount(tp,LOCATION_HAND,0)~=0 and e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,82204200)  
end
...
function cm.operation(e,tp,eg,ep,ev,re,r,rp)  
	local c=e:GetHandler()  
	--this part of effect is reduced
	--local e1=Effect.CreateEffect(c)  
