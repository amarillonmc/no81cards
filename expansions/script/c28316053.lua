...
function c28316053.suop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) and sel==0 then
		...
		tc:RegisterFlagEffect(0,RESET_EVENT+RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringid(28316053,0))
	elseif tc:IsFaceup() and tc:IsRelateToEffect(e) and sel==1 then
		...
		tc:RegisterFlagEffect(0,RESET_EVENT+RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringid(28316053,1))
	elseif tc:IsFaceup() and tc:IsRelateToEffect(e) and sel==2 then
		...
		tc:RegisterFlagEffect(0,RESET_EVENT+RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringid(28316053,2))
	elseif tc:IsFaceup() and tc:IsRelateToEffect(e) and sel==3 then
		...
		tc:RegisterFlagEffect(0,RESET_EVENT+RESETS_STANDARD,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringid(28316053,3))
	end
end
