...
function cm.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return Duel.IsExistingMatchingCard(cm.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) and c:IsCanRemoveCounter(tp,0x9539,1,REASON_COST) end
	local lvt={}
	local pc=1
	for i=1,12 do
