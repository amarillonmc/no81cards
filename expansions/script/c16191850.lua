...
function s.eftg(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    local b2=c:IsAbleToGrave() and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
...
function s.atktg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return con and Duel.IsExistingMatchingCard(s.atkfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
...
function s.atkop(e,tp,eg,ep,ev,re,r,rp)
    ...
    Duel.AdjustAll()
    if res and Duel.IsExistingMatchingCard(Card.IsAbleToGrave,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil)
