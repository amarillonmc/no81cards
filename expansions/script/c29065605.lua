...
function c29065605.matfilter1(c)
	return c:IsSynchroType(TYPE_TUNER) or (c:IsSetCard(0x7ad) and c:IsLevel(4))
end
function c29065605.eqcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_SYNCHRO) and e:GetHandler():GetMaterial():Filter(Card.IsSetCard,nil,0x7ad):GetCount()>0
end
