...
function cm.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if g:GetFirst():IsSetCard(0x5f3d) then
...
function cm.srfilter(c)
	return c:IsSetCard(0xf3d) and (c:IsType(TYPE_SPELL) or c:IsType(TYPE_TRAP)) and c:IsAbleToHand()
end
