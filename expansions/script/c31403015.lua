...
function cm.effectfilter(e,ct)
	...
	return e:GetHandlerPlayer()==tp and te:GetHandler():IsSetCard(0xc311) and te:IsActiveType(TYPE_SPELL+TYPE_TRAP)
end
...
function cm.disfilter(c)
	return c:IsSetCard(0xc311) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave() and Duel.IsExistingMatchingCard(cm.thfilter,tp,LOCATION_DECK,0,1,c)
end
