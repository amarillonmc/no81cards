...
function c71404003.tg2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_SZONE)>0
		and Duel.IsExistingMatchingCard(c71404003.filter2,tp,LOCATION_GRAVE+LOCATION_REMOVED,0,1,nil) end
...
function c71404003.op2(e,tp,eg,ep,ev,re,r,rp)
	...
	e2:SetTarget(c71404003.mattg)
	e2:SetValue(c71404003.matval)
...
function c71404003.mattg(e,c)
	return c:IsFaceupEx() and c:IsType(TYPE_SPELL)
end
function c71404003.matval(e,lc,mg,c,tp)
