...
function c13131380.tdcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return eg:GetCount()==1 and tc:IsSetCard(0x3b00) and tc:IsType(TYPE_MONSTER)
end
function c13131380.spfilter(c,e,tp,tc)
	return c:IsSetCard(0x3b00) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(tc:GetCode()) 
end
