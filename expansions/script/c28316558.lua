...
function c28316558.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	c28316558.cost(e,tp,eg,ep,ev,re,r,rp,1)
...
function c28316558.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if (ANTICA_EFFECT_HINT or c:IsReason(REASON_DESTROY)) and #g>0 and Duel.GetMZoneCount(p)>0 then
