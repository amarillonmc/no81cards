...
function cm.initial_effect(c)
	...
	e1:SetCountLimit(1,188899) 
	e1:SetTarget(c188899.sptg) 
	e1:SetOperation(c188899.spop) 
	c:RegisterEffect(e1)  
	local e2=e1:Clone() 
...
function c188899.sptg(e,tp,eg,ep,ev,re,r,rp,chk)  
	if chk==0 then return Duel.IsExistingMatchingCard(aux.NecroValleyFilter(function(c,e,tp)return c:IsSetCard(0xca6) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)end),tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil,e,tp) end 
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_HAND+LOCATION_GRAVE)
end 
function c188899.spop(e,tp,eg,ep,ev,re,r,rp) 
	local c=e:GetHandler()
