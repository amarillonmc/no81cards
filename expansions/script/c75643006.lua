...
function s.efcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(s.cfilter,tp,LOCATION_ONFIELD,0,1,nil) and Duel.IsAbleToEnterBP()
end
...
function s.filter(c)
	return aux.IsCodeListed(c,75643010) and c:IsDiscardable(REASON_EFFECT)
end
