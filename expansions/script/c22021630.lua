...
function c22021630.tgfilter(c,lv,e,tp)
	return c:IsSetCard(0x2ff1) and c:IsType(TYPE_FUSION) and c:IsLevelBelow(lv-1) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and Duel.GetLocationCountFromEx(tp,tp,rc,c)>0
end
