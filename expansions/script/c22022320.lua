...
function c22022320.initial_effect(c)
	...
	e6:SetDescription(aux.Stringid(22022320,4))
	e6:SetType(EFFECT_TYPE_IGNITION)
	e6:SetRange(LOCATION_MZONE)
	e6:SetCountLimit(1,22022321)
	e6:SetTarget(c22022320.xtg)
	e6:SetOperation(c22022320.xop)
	c:RegisterEffect(e6)
	--atkup
...
function c22022320.xtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_DICE,nil,0,tp,1)
end
function c22022320.xop(e,tp,eg,ep,ev,re,r,rp)
	...
	elseif dc==4 or dc==5 or dc==6 then
		...
		Duel.Overlay(e:GetHandler(),Duel.GetDecktopGroup(1-tp,2))
	end
end