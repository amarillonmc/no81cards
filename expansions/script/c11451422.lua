...
function cm.initial_effect(c)
	...
	e1:SetCategory(CATEGORY_DISABLE+CATEGORY_SSET+CATEGORY_TOGRAVE)
...
function cm.hand(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(cm.filter,e:GetHandlerPlayer(),LOCATION_HAND,0,1,e:GetHandler()) end
