...
function s.drcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	cg:AddCard(c)
	if chk==0 then return Duel.IsExistingMatchingCard(s.drcfilter,tp,LOCATION_ONFIELD,0,1,nil,cg) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RELEASE)
	local g=Duel.SelectMatchingCard(tp,s.drfilter,tp,LOCATION_ONFIELD,0,1,1,nil,cg)
