...
function s.exop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ct==2 and s.boostg(e,tp,eg,ep,ev,re,r,rp,0) then
		Duel.BreakEffect()
...
function s.boostg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(Card.IsAbleToRemove,tp,LOCATION_GRAVE,LOCATION_GRAVE,1,nil)
		and Duel.SelectYesNo(tp,1102) end
end
