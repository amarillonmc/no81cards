...
function cm.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)  
	...
	if chk==0 then return Duel.IsExistingTarget(cm.tgfilter1,tp,LOCATION_MZONE,0,1,nil,e,tp) and Duel.IsExistingTarget(cm.sp2filter,tp,LOCATION_GRAVE,0,1,nil) end 
