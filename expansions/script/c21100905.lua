...
function cm.initial_effect(c)
	...
	cm._ = true
		...
		cm.A_string = {"「环球旅行家 贺兰」记录过的区域为 ","「环球旅行家 贺兰」记录过的区域为 "}
