...
function c22348403.costfilter(c)
	return c:IsAbleToGraveAsCost() and c:IsType(TYPE_NORMAL)
end
...
function c22348403.spfilter(c,e,tp)
	return c:IsFaceup() and c:IsCode(22348402,22348401) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c22348403.desreptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	local g=Duel.GetMatchingGroup(c22348403.spfilter,tp,LOCATION_PZONE+LOCATION_EXTRA,0,nil,e,tp)
	Group.Sub(g,eg)
