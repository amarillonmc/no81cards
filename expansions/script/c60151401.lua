...
function c60151401.initial_effect(c)
	...
	e0:SetOperation(c60151401.e0op)
	c:RegisterEffect(e0)
end
function c60151401.e0opf(c,tp)
	return c:IsLocation(LOCATION_ONFIELD)
end
function c60151401.e0op(e,tp,eg,ep,ev,re,r,rp)
	if re:IsHasProperty(EFFECT_FLAG_CARD_TARGET) then
		local g=Duel.GetChainInfo(ev,CHAININFO_TARGET_CARDS)
		if g and g:IsExists(c60151401.e0opf,1,nil,tp) then
			e:GetHandler():RegisterFlagEffect(60151401,RESET_EVENT+RESETS_STANDARD+RESET_CHAIN,0,1)
		end
	end
end
...
function c60151401.spcon2(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(60151401)>0
end
