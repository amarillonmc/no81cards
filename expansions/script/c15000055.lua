...
function cm.spfilter(c,e,tp)
	return c:IsSetCard(0xf33) and c:IsLevelBelow(3) and c:IsFaceup() and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and Duel.GetLocationCountFromEx(tp,tp,nil,c)~=0
end
