...
function cm.lcheck(c)
	return (c:IsLevelAbove(4) and c:IsLinkSetCard(0x562)) or (c:GetOriginalCode()==33300308 and not c:IsDisabled())
end
...
function cm.spcheck(c,e,tp)
	return c:IsSetCard(0x562) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and c:IsLevelAbove(4)
end
