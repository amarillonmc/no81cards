...
function cm.activate(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==0 then
		...
		local g=Duel.SelectMatchingCard(tp,cm.f2,tp,LOCATION_DECK,0,1,1,nil)
		if #g>0 then
