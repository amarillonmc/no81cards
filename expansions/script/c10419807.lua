...
function cm.initial_effect(c)
	...
	e10:SetHintTiming(TIMING_DAMAGE_STEP,TIMING_DAMAGE_STEP+TIMING_END_PHASE)
...
function cm.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.GetTurnCount()>=3 then Duel.RegisterFlagEffect(tp,10419902,RESET_PHASE+PHASE_END,0,1) end
...
function cm.targett(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(Card.IsFaceup,tp,LOCATION_MZONE,0,1,nil) and cm.TargetReflect1(e,tp,eg,ep,ev,re,r,rp,0)
	   and cm.TargetReflect2(e,tp,eg,ep,ev,re,r,rp,0) 
	   and cm.TargetReflect3(e,tp,eg,ep,ev,re,r,rp,0) 
	   and cm.TargetReflect4(e,tp,eg,ep,ev,re,r,rp,0) 
	   and cm.TargetReflect5(e,tp,eg,ep,ev,re,r,rp,0) end
