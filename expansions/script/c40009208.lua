...
function c40009208.filter1(c,e,tp)
	...
	return c:IsFaceup() and c:IsSetCard(0xf1c)
		and Duel.IsExistingMatchingCard(c40009208.filter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,c,rk+1)
...
function c40009208.filter2(c,e,tp,mc,rk)
	return c:IsRank(rk) and c:IsSetCard(0xf1c) and mc:IsCanBeXyzMaterial(c)
