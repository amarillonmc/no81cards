...
function c118824150.rvtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return aux.MustMaterialCheck(nil,tp,EFFECT_MUST_BE_SMATERIAL) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingTarget(c118824150.rvfilter,tp,LOCATION_GRAVE,0,1,e:GetHandler(),e,tp) end
