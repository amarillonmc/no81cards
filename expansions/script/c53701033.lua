...
function cm.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x3530) and c:IsLevelAbove(3) and c:IsLevelBelow(8)
end
...
function cm.thfilter(c)
	return c:IsSetCard(0x3530) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToHand()
end
