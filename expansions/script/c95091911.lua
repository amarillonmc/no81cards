...
function s.startop(e,tp,eg,ep,ev,re,r,rp) 
  if aa == 1 then
	local eq=Duel.CreateToken(tp,38576155)
	local c=e:GetHandler()
	Duel.MoveToField(eq,tp,tp,LOCATION_SZONE,POS_FACEDOWN,false)
...
function s.op2(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=eg:Filter(Card.IsControler,nil,tp):Filter(Card.IsCode,nil,table.unpack(s.codes))
