...
function c22020380.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(22020380,1))
	e5:SetCategory(CATEGORY_DESTROY)
	e5:SetType(EFFECT_TYPE_QUICK_O)
	e5:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e5:SetCode(EVENT_FREE_CHAIN)
	e5:SetRange(LOCATION_GRAVE)
	e5:SetCountLimit(1,22020380)
	e5:SetHintTiming(0,TIMINGS_CHECK_MONSTER+TIMING_END_PHASE)
	e5:SetCondition(c22020380.erescon)
	e5:SetCost(c22020380.erecost)
	e5:SetTarget(c22020380.destg)
	e5:SetOperation(c22020380.desop)
	c:RegisterEffect(e5)
end
c22020380.effect_canequip_hogu=true
function c22020380.costfilter(c)
	return c:IsSetCard(0xff1) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsAbleToRemoveAsCost()
end
...
function c22020380.erescon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22020380.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c22020380.costfilter,tp,LOCATION_GRAVE,0,1,nil) end
