...
function c33201401.thfilter1(c)
	return c:IsLevelAbove(0) and c:IsFaceup()
end
function c33201401.thtg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.IsExistingMatchingCard(c33201401.thfilter1,tp,LOCATION_MZONE,LOCATION_MZONE,1,e:GetHandler()) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c33201401.thop1(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsRelateToEffect(e) and c:IsFaceup() and Duel.IsExistingMatchingCard(c33201401.thfilter1,tp,LOCATION_MZONE,LOCATION_MZONE,1,e:GetHandler()) then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SELECT)
		local g=Duel.SelectMatchingCard(tp,c33201401.thfilter1,tp,LOCATION_MZONE,LOCATION_MZONE,0,1,1,e:GetHandler())
