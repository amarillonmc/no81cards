...
function s.initial_effect(c)
	...
	-- 把这张卡从手卡丢弃才能发动，从卡组选「堕福的残吟·寻声姬 」以外的1只「堕福」怪兽加入手卡或送去墓地
...
function s.cfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x666c) and not c:IsCode(id) and (c:IsAbleToHand() or c:IsAbleToGrave())
end
