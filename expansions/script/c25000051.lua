...
function cm.initial_effect(c)
	...
	local e2=rsef.I(c,{m,0},nil,"dr,rm",nil,LOCATION_GRAVE,aux.exccon,rscost.cost(cm.cfilter2,"td",LOCATION_GRAVE,0,1,3),rsop.target({1,"dr"},{rssb.rmfilter,"rm"}),cm.drop)
end
