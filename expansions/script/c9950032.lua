...
function c9950032.cfilter(c,att)
	return c:IsFaceup() and c:IsAttribute(att) and c:IsSetCard(0xba1,0xba2,0xba3,0xba4)
end
function c9950032.dfilter2(c)
...
function c9950032.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c9950032.cfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil,ATTRIBUTE_LIGHT)
		and Duel.IsExistingMatchingCard(c9950032.cfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil,ATTRIBUTE_WATER)
...
function c9950032.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(aux.TRUE,tp,0,LOCATION_MZONE,1,nil)
		or Duel.IsExistingMatchingCard(c9950032.dfilter2,tp,0,LOCATION_ONFIELD,1,nil)
...
function c9950032.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsExistingMatchingCard(c9950032.dfilter2,tp,0,LOCATION_ONFIELD,1,nil) then
	...
	elseif opval[op]==2 then
		local g=Duel.GetMatchingGroup(c9950032.dfilter2,tp,0,LOCATION_ONFIELD,nil)
		Duel.Destroy(g,REASON_EFFECT)
