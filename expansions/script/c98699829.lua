...
function cm.rmcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return Duel.IsChainDisablable(ev) and re:IsActiveType(TYPE_MONSTER) and (LOCATION_HAND+LOCATION_GRAVE)&loc~=0
end
function cm.rmcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsCanRemoveCounter(tp,0x0876,1,REASON_COST) end
	e:GetHandler():RemoveCounter(tp,0x0876,1,REASON_COST)
end
