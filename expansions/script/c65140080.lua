...
function s.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 and Duel.SendtoGrave(g,REASON_EFFECT)>0 and g:FilterCount(Card.IsLocation,nil,LOCATION_GRAVE)>0 and Duel.GetMatchingGroupCount(aux.TRUE,tp,LOCATION_MZONE,0,c)==0 then
