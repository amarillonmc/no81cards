...
function c11579800.accost(e,tp,eg,ep,ev,re,r,rp,chk) 
	if chk==0 then return Duel.IsExistingMatchingCard(function(c) return c:IsFaceup() and c:IsCode(10000020) end,tp,LOCATION_MZONE,0,1,nil) or Duel.IsExistingMatchingCard(Card.IsReleasable,tp,LOCATION_MZONE,0,3,nil) end 
	if not Duel.IsExistingMatchingCard(function(c) return c:IsFaceup() and c:IsCode(10000020) end,tp,LOCATION_MZONE,0,1,nil) then 
