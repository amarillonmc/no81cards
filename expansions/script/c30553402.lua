--霓创深域进程 [Search]
local s,id,o=GetID()
function c30553402.initial_effect(c)
	--spsummon
...
function s.thfilter(c)
	return c:IsSetCard(0x309) and c:IsAbleToHand() and c:IsType(TYPE_MONSTER)
end
...
function s.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.Remove(c,POS_FACEUP,REASON_EFFECT)~=0 then
		...
		c:RegisterFlagEffect(30553402,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
	end
end
function s.spfilter(c,e,tp)
	return c:GetFlagEffect(30553402)~=0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,30553402)
