...
c7409795.Grimy_Goons=true
function c7409795.Grimy_Goons_filter(c)
...
function c7409795.drop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Draw(p,d,REASON_EFFECT)==2 then
		...
		if tg:GetCount()>0 then
			...
			while tc do
				local e1=Effect.CreateEffect(c)
				e1:SetDescription(aux.Stringid(7409795,3))
			...
			local num=tg:Filter(c7409795.Grimy_Goons_filter,nil):GetCount()
