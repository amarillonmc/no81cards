...
function cm.op2(e,tp,eg,ep,ev,re,r,rp)
	...
	e4:SetTarget(function(e,c) c:RegisterFlagEffect(m,RESET_EVENT+RESETS_STANDARD-RESET_REMOVE-RESET_LEAVE-RESET_TEMP_REMOVE,0,1) return true end)
...
function cm.reset(e,tp,eg,ep,ev,re,r,rp)
	if eg:IsExists(cm.redfilter,1,nil,e) then e:GetLabelObject():Reset() e:Reset() end
end
