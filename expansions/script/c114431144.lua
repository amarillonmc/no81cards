...
function c114431144.operation2(e,tp,eg,ep,ev,re,r,rp)
    ...
    if Duel.SendtoDeck(tg,nil,nil,REASON_SPSUMMON)==2 and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)==1 and Duel.GetLocationCountFromEx(tp,tp,tc,c)>0 then
        Duel.BreakEffect()
