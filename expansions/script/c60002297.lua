...
local cm,m=lanp.U("设置卡","黄昏+黄昏教廷","黄昏教廷神子·哈文森")
dusk[m]={}
...
function cm.con(e,tp,eg,ep,ev,re,r,rp)
	...
	return lanc.Filter(c,"IsLoc+IsFaceup","E") and lang.Get(tp,"E"):GetCount()>=15 and lang.GetFilter(tp,"N","IsName+IsFaceup","黄昏教廷神子·辛勒斯",1 )
end
...
function cm.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if lanp.U("效果处理",Duel.SendtoHand,c,{nil,"EFF"})>0 and Duel.GetFlagEffect(tp,m)==0 then
		...
		local e2=lane.F(e,tp,"",41,"SR,,N+0,1,,",aux.TargetBoolFunction(lanc.IsName,"黄昏教廷神子·辛勒斯"),"",{RESET_PHASE+PHASE_END,3})
		local e3=lane.F(e,tp,"",42,"SR,,N+0,1,,",aux.TargetBoolFunction(lanc.IsName,"黄昏教廷神子·辛勒斯"),"",{RESET_PHASE+PHASE_END,3})
		table.insert(dusk.begin,e1)
		table.insert(dusk[m],c)
		table.insert(dusk[m],e1)
		table.insert(dusk[m],e2)
		table.insert(dusk[m],e3)
...
function cm.tg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return lang.GetFilter(tp,{"0","M"},"TgChk",e,1) end
	lanp.U("提示","S",tp,"DES")
	local g=lang.SelectTg(tp,{0,"M"},"TgChk",e)
	g:AddCard(c)
