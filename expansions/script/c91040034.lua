...
function cm.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return  Duel.IsExistingMatchingCard(cm.spcostfilter,tp,LOCATION_MZONE,0,1,e:GetHandler(),c,tp,Card.IsAbleToGraveAsCost) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,cm.spcostfilter,tp,LOCATION_MZONE,0,1,1,e:GetHandler(),tp)
