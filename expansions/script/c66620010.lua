...
function s.initial_effect(c)
	...
	-- 这个回合对方是已把怪兽的效果发动的场合才能发动，这张卡从手卡特殊召唤
	...
	-- 自己主要阶段才能发动，从卡组把「绮奏·枪裁逆律·芙蕾娅」以外的1只「绮奏」怪兽加入手卡
	...
	-- 这张卡是除外状态，自己场上的表侧表示的融合怪兽因对方的效果从场上离开的场合或者被战斗破坏的场合才能发动，这张卡特殊召唤
...
function s.thfilter(c)
	return not c:IsCode(id) and c:IsSetCard(0x666a) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
