...
function cm.eqop1(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and c:IsFaceup() and Duel.GetLocationCount(tp,LOCATION_SZONE)>0 and sc:CheckEquipTarget(c) and Duel.SelectYesNo(tp,aux.Stringid(m,4)) then
		Duel.Equip(tp,sc,c)
	else
