...
function s.mfilter(c)
	return c:IsLinkSetCard(0x2e) and c:IsLinkType(TYPE_MONSTER)
end
...
function s.eqfilter(c)
	return c:IsFaceup() and c:IsRace(RACE_SPELLCASTER) and c:IsAttribute(ATTRIBUTE_DARK) and not c:IsType(TYPE_LINK)
end
