...
function s.filter1(c)
	return c:IsFaceup() and c:IsSetCard(0x3a76) and not c:IsCode(12825720) and c:IsType(TYPE_XYZ) and c:GetOverlayCount()>=4
end
function s.filter2(c)
	return c:IsCode(12825720)
end
function s.cfilter(c)
	return c:IsFaceup() and c:IsCode(12825720)
end
