...
function c114562761.slop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) and aux.NecroValleyFilter()(tc) then
...
function c114562761.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c114562761.thfilter),tp,LOCATION_GRAVE,0,2,2,nil)
	local tc=g:GetFirst()
