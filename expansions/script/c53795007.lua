...
function cm.initial_effect(c)
	...
	e2:SetValue(function(e,c)return c:IsAttribute(ATTRIBUTE_EARTH)end)
	c:RegisterEffect(e2)
	...
	e4:SetCondition(function(e)return e:GetHandler():GetEquipTarget():GetControler()==e:GetHandlerPlayer()end)
	e4:SetValue(1)
	c:RegisterEffect(e4)
end
