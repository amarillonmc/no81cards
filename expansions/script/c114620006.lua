...
function cm.rfilter(c)
    return c:IsSetCard(0xe6f) and c:IsType(TYPE_MONSTER) and c:IsAbleToRemoveAsCost()
end
function cm.rfilter2(c)
    return c:IsSetCard(0xe6f) and c:IsType(TYPE_MONSTER) and c:IsFaceup()
end
...
function cm.thfilter(c)
    return c:IsSetCard(0xe6f) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
