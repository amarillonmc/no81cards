...
function cm.initial_effect(c)
	...
	e0:SetCondition(c60152303.e0con)
	c:RegisterEffect(e0)
	--
...
function c60152303.e0confilter(c)
	return c:IsFaceup() and c:IsSetCard(0xcb26) and c:GetCode()~=60152303
end
function c60152303.e0con(e,c)
	if c==nil then return true end
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0 and
		Duel.IsExistingMatchingCard(c60152303.e0confilter,c:GetControler(),LOCATION_MZONE,0,1,nil)
end
