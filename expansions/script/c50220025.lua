...
function c50220025.initial_effect(c)
	...
	e2:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x116))
	...
	e7:SetCountLimit(1,50220026)
	e7:SetCondition(c50220025.drcon)
	e7:SetTarget(c50220025.drtg)
	e7:SetOperation(c50220025.drop)
	c:RegisterEffect(e7)
end
