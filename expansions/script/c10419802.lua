...
function cm.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(cm.filter,tp,0,LOCATION_MZONE,1,nil) and cm.TargetReflect1(e,tp,eg,ep,ev,re,r,rp,0)
	   ...
	   and cm.TargetReflect5(e,tp,eg,ep,ev,re,r,rp,0) 
	end
