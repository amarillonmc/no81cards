...
function c22021110.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(22021110,4))
	e4:SetCategory(CATEGORY_TOHAND)
	e4:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e4:SetRange(LOCATION_GRAVE)
	e4:SetCountLimit(1)
	e4:SetCode(EVENT_PHASE+PHASE_END)
	e4:SetCondition(c22021110.pretcon1)
	e4:SetCost(c22021110.erecost)
	e4:SetTarget(c22021110.prettg)
	e4:SetOperation(c22021110.pretop)
	c:RegisterEffect(e4)
end
...
function c22021110.pretcon1(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp and Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22021110.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
