...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    if re and re:GetHandler():IsSetCard(0x364b) then
    	e:SetCategory(CATEGORY_TOHAND+CATEGORY_SPECIAL_SUMMON+CATEGORY_SEARCH)    	
    end
end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)~=0 
    	and re and re:GetHandler():IsSetCard(0x364b) and Duel.IsExistingMatchingCard(s.thfilter,tp,LOCATION_DECK,0,1,nil) 
