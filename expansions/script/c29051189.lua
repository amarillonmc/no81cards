...
function c29051189.initial_effect(c)
	...
	e2:SetCondition(c29051189.spcon)
...
function c29051189.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c29051189.spfilter,tp,LOCATION_GRAVE,0,1,e:GetHandler(),e,tp) end
...
function c29051189.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c29051189.spfilter),tp,LOCATION_GRAVE,0,1,1,e:GetHandler(),e,tp)
