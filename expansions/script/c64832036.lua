...
local m,cm=rscf.DefineCard(64832036)
...
function cm.otcon(e,c,minc)
	...
	local mg=Duel.GetMatchingGroup(Card.IsSetCard,tp,LOCATION_MZONE,0,nil,0x6410)
...
function cm.negcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return re:IsActiveType(TYPE_MONSTER) and Duel.IsChainNegatable(ev) and loc & (LOCATION_MZONE+LOCATION_GRAVE)~=0 and trp~=tp and rscon.excard2(Card.IsSetCard,LOCATION_ONFIELD,0,2,nil,0x6410)(e,tp)
end
...
function cm.chainop(e,tp,eg,ep,ev,re,r,rp)
	if not rscon.excard2(Card.IsSetCard,LOCATION_MZONE,0,1,nil,0x6410)(e,tp) then
		Duel.SetChainLimit(cm.chainlm1)
	end
	if not rscon.excard2(Card.IsSetCard,LOCATION_MZONE,0,1,nil,0x6410)(e,1-tp) then
