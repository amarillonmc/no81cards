...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	Duel.AddCustomActivityCounter(id+10000,ACTIVITY_CHAIN,s.chainfilter)
end
...
function s.spcon(e,c)
	...
	return Duel.GetCustomActivityCount(id+10000,1-tp,ACTIVITY_CHAIN)>0 and Duel.GetTurnPlayer()==tp and g:GetCount()>0 and g:GetCount()==g:FilterCount(Card.IsCanOverlay,nil)
end
