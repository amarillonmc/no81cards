...
function c22022410.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(22022410,1))
	e3:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetCountLimit(1)
	e3:SetRange(LOCATION_GRAVE)
	e3:SetCondition(c22022410.erecon)
	e3:SetCost(c22022410.erecost)
	e3:SetTarget(c22022410.sptg1)
	e3:SetOperation(c22022410.spop1)
	c:RegisterEffect(e3)
end
...
function c22022410.erecon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22022410.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
