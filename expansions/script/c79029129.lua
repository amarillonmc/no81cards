...
function c79029129.initial_effect(c)
	...
	e1:SetCountLimit(1,790291299999+EFFECT_COUNT_CODE_DUEL)
	...
	e5:SetCountLimit(1,7902912999999+EFFECT_COUNT_CODE_DUEL)
...
function c79029129.thcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(Card.IsSetCard,tp,LOCATION_PZONE,0,1,e:GetHandler(),0xf02)
end
