...
function s.cfilter(c,tp)
	return c:IsSetCard(0x3cf4) and c:IsType(TYPE_MONSTER) and Duel.GetMZoneCount(tp,c)>0
end
...
function s.rlfilter(c)
	return not c:IsCode(id) and c:IsSetCard(0x3cf4) and c:IsType(TYPE_MONSTER) and c:IsReleasableByEffect()
end
