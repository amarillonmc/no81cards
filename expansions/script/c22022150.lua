...
function c22022150.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(22022150,2))
	e3:SetCategory(CATEGORY_DAMAGE)
	e3:SetType(EFFECT_TYPE_QUICK_O)
	e3:SetCode(EVENT_CHAINING)
	e3:SetRange(LOCATION_GRAVE)
	e3:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_PLAYER_TARGET)
	e3:SetCondition(c22022150.damcon1)
	e3:SetCost(c22022150.erecost)
	e3:SetTarget(c22022150.damtg)
	e3:SetOperation(c22022150.damop)
	c:RegisterEffect(e3)
	--destroy
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringid(22022150,3))
	...
	e4:SetCountLimit(1)
	e4:SetCondition(c22022150.descon1)
	e4:SetCost(c22022150.erecost)
	e4:SetTarget(c22022150.destg)
	e4:SetOperation(c22022150.desop)
	c:RegisterEffect(e4)
end
...
function c22022150.damcon1(e,tp,eg,ep,ev,re,r,rp)
...
function c22022150.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.Hint(HINT_CARD,0,22020980)
	Duel.PayLPCost(tp,math.floor(Duel.GetLP(tp)/2))
end
function c22022150.descon1(e,tp,eg,ep,ev,re,r,rp)
