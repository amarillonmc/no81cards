...
function cm.initial_effect(c)
	...
	e1:SetCondition(aux.LinkCondition(cm.matfilter,1,1,nil))
	e1:SetTarget(aux.LinkTarget(cm.matfilter,1,1,nil))
	e1:SetOperation(aux.LinkOperation(cm.matfilter,1,1,nil))
	e1:SetValue(SUMMON_TYPE_LINK+SUMMON_VALUE_SELF)
	c:RegisterEffect(e1)
