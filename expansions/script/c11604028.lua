...
function s.efilter(e,te)
	return e:GetHandlerPlayer()~=te:GetOwnerPlayer() and te:IsActiveType(TYPE_MONSTER)
end
function s.efilter2(e,te)
	return e:GetHandlerPlayer()~=te:GetOwnerPlayer() and te:IsActiveType(TYPE_SPELL+TYPE_TRAP) and te:GetOwner():IsSetCard(0x9224)
end
--
