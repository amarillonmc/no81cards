...
function c9910262.filter(c)
	return not c:IsCode(9910262) and c:IsSetCard(0xa956) and c:IsAbleToHand()
end
...
function c9910262.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 and Duel.SendtoHand(g,nil,REASON_EFFECT)>0 then
		...
		local tg=Duel.GetMatchingGroup(Card.IsCanAddCounter,tp,LOCATION_ONFIELD,0,aux.ExceptThisCard(e),0x956,1)
