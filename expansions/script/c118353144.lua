...
Duel.Damage=function(tp,amount,reason)
	local ag=Duel.GetMatchingGroup(aux.NecroValleyFilter(c118353144.adfilter),tp,LOCATION_GRAVE,0,nil)
...
function c118353144.rdop(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(aux.NecroValleyFilter(c118353144.adfilter),tp,LOCATION_GRAVE,0,nil)
