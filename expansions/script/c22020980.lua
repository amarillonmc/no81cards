...
function c22020980.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(22020980,1))
	...
	e2:SetCondition(c22020980.spcon)
	...
	e3:SetCondition(c22020980.ctcon)
	c:RegisterEffect(e3)
end
...
function c22020980.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.MoveToField(c,tp,tp,LOCATION_SZONE,POS_FACEUP,true) then
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringid(22020980,3))
...
function c22020980.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetType()==TYPE_TRAP+TYPE_CONTINUOUS 
end
function c22020980.ctcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetLP(tp)>=2500 and e:GetHandler():GetType()==TYPE_TRAP+TYPE_CONTINUOUS 
end