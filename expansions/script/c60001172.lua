...
function c60001172.setop(e,tp,eg,ep,ev,re,r,rp)
	local tg=eg:Filter(c60001172.setter,nil)
...
function c60001172.fsop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local a1,a2,a3,a4,zone=Duel.GetOperationInfo()
	local e1=Effect.CreateEffect(c)
	...
	e4:SetCountLimit(1)
	e4:SetOperation(c60001172.ntop)
	Duel.RegisterEffect(e4,1-tp)
end
function c60001172.ntop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
