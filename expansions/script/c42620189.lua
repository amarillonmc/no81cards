...
function cm.thfilter(c)
	return c:IsSetCard(0x153) and c:IsAbleToHand() and c:IsType(TYPE_MONSTER)
end
...
function cm.tgtfilter(c)
    return c:IsSetCard(0x153) and c:IsType(TYPE_LINK) and c:IsAbleToDeck()
end

function cm.tgtfilter2(c,e)
    return c:IsSetCard(0x153) and c:IsType(TYPE_LINK) and c:IsAbleToDeck() and c:IsCanBeEffectTarget(e)
end
