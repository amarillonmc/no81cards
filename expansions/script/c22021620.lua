...
function c22021620.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(22021620,2))
	e5:SetCategory(CATEGORY_REMOVE)
	e5:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e5:SetCode(EVENT_SPSUMMON_SUCCESS)
	e5:SetRange(LOCATION_GRAVE)
	e5:SetCondition(c22021620.rmcon1)
	e5:SetCost(c22021620.erecost)
	e5:SetTarget(c22021620.rmtg)
	e5:SetOperation(c22021620.rmop)
	c:RegisterEffect(e5)
end
...
function c22021620.rmtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SelectOption(tp,aux.Stringid(22021620,3))
end
...
function c22021620.rmcon1(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c22021620.cfilter,1,nil,tp) and Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22021620.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
