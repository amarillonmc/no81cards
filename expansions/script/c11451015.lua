...
function cm.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		return res and Duel.CheckReleaseGroup(tp,cm.rfilter,2,nil) and Duel.CheckReleaseGroup(tp,cm.rfilter2,1,nil,tp,c)
	end
end
...
function cm.costop(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg=g:SelectSubGroup(tp,cm.fselect,false,2,2,tp,c)
