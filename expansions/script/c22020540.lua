...
function c22020540.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(22020540,3))
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetRange(LOCATION_GRAVE)
	e3:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e3:SetCountLimit(1,22020541)
	e3:SetCondition(c22020540.erescon)
	e3:SetCost(c22020540.erecost)
	e3:SetTarget(c22020540.copytg)
	e3:SetOperation(c22020540.copyop)
	c:RegisterEffect(e3)
end
...
function c22020540.copytg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SelectOption(tp,aux.Stringid(22020540,4))
...
function c22020540.erescon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22020540.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
