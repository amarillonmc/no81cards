...
function s.filter2(c,e,tp,mc,rk)
	return not c:IsRank(rk) and c:IsSetCard(0x332b) and c:IsType(TYPE_XYZ) and mc:IsCanBeXyzMaterial(c)
...
function s.drfilter(c)
	return c:IsSetCard(0x332b) and c:IsType(TYPE_MONSTER) and c:IsAbleToDeck()
end
