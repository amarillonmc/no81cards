function c118426889.initial_effect(c)
    aux.AddLinkProcedure(c,aux.FilterBoolFunction(Card.IsLinkSetCard,0x97),2,2)
    c:EnableReviveLimit()
    ...
    e4:SetDescription(aux.Stringid(118426889,0))
    ...
    e5:SetDescription(aux.Stringid(118426889,1))
    ...
    e6:SetDescription(aux.Stringid(118426889,2))
