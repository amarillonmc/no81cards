...
function c22022010.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(22022010,2))
	...
	e3:SetCountLimit(1,22022010)
	e3:SetCondition(c22022010.erecon)
	e3:SetCost(c22022010.erecost)
	e3:SetTarget(c22022010.destg)
	e3:SetOperation(c22022010.desop)
	c:RegisterEffect(e3)
end
...
function c22022010.tgfilter(c,atk)
	return c:IsAttackAbove(atk) and c:IsAbleToGrave() and c:IsType(TYPE_SYNCHRO) and c:IsSetCard(0x6ff1) 
end
...
function c22022010.erecon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22022010.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
