...
function c40008818.initial_effect(c)
	...
	e1:SetTarget(c41729254.sslimit)
	c:RegisterEffect(e1)
	--to grave
...
function c40008818.spfilter(c,e,tp)
	return c:IsPreviousLocation(LOCATION_ONFIELD) and c:IsControler(1-tp) and c:IsReason(REASON_BATTLE+REASON_EFFECT+REASON_COST+REASON_MATERIAL)
