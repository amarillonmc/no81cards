...
function c4058.initial_effect(c)
    ...
    e20:SetTarget(aux.TargetBoolFunction(Card.IsCode,80678380))
    ...
    e22:SetTarget(aux.TargetBoolFunction(Card.IsCode,93217231))
    ...
    e26:SetTarget(aux.TargetBoolFunction(Card.IsCode,93217231,80678380,16067089,1683982))
