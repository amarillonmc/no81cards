...
function cm.initial_effect(c)
	...
	e1:SetCountLimit(1,10400009+EFFECT_COUNT_CODE_OATH)
...
function c10400009.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c10400009.filter2),tp,LOCATION_GRAVE,0,1,1,nil)
