...
function c22348222.smfilter(c,lscale,rscale)
	local lv=c:GetLevel()
...
function c22348222.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	return Duel.IsExistingMatchingCard(c22348222.smfilter,tp,LOCATION_EXTRA,0,1,nil,lscale,rscale)end
...
function c22348222.sumop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c22348222.smfilter,tp,LOCATION_EXTRA,0,1,1,nil,lscale,rscale)
	local tc=g:GetFirst()
