...
function c71500103.initial_effect(c) 
	...
	e1:SetOperation(c71500103.SpiritReturnReg)
	c:RegisterEffect(e1)
	--ritual level
	local e1=Effect.CreateEffect(c)
...
function c71500103.sprcon(e,tp,eg,ep,ev,re,r,rp) 
	return e:GetHandler():IsReason(REASON_RITUAL) and e:GetHandler():IsLocation(LOCATION_GRAVE)
end 
function c71500103.SpiritReturnReg(e,tp,eg,ep,ev,re,r,rp)
