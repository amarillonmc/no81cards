...
function c22020620.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(22020620,0))
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_SZONE)
	e2:SetCountLimit(1,22020620+EFFECT_COUNT_CODE_DUEL)
...
function c22020620.activate0(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(1-tp,LOCATION_MZONE)<=0
		or not Duel.IsPlayerCanSpecialSummonMonster(tp,22020611,0,0x4011,1200,1200,1,RACE_SPELLCASTER,ATTRIBUTE_EARTH,POS_FACEUP_ATTACK,1-tp) then return end
