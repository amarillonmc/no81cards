...
function c11513084.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return (ct>1 or dis) and g:CheckSubGroup(aux.dabcheck,1,3) end
	if c:IsStatus(STATUS_SET_TURN) and (ct>1 or dis) and Duel.SelectYesNo(tp,aux.Stringid(11513084,0)) then
