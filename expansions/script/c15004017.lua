...
function cm.dzcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(cm.valfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) and not e:GetHandler():IsHasEffect(15004018)
end
