...
function cm.initial_effect(c)
	...
	local e3=rsef.I(c,{m,1},{1,m+200},"tg",nil,LOCATION_GRAVE,nil,rscost.cost({Card.IsAbleToRemoveAsCost,"rm"},{Card.IsDiscardable,"dish",LOCATION_HAND }),rsop.target(cm.tdfilter,"td",LOCATION_DECK),cm.tdop)
end
