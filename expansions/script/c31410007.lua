...
function cm.reptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return eg:IsExists(cm.reptgfilter,1,nil,tp) and Duel.IsExistingMatchingCard(cm.repfilter,tp,LOCATION_REMOVED,0,1,nil) and e:GetHandler():GetFlagEffect(31410000)>0 end
