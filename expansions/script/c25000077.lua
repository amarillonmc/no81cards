...
function cm.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	e:GetHandler():RegisterFlagEffect(m+100000000,RESET_EVENT+RESETS_STANDARD,0,1,fid)
...
function cm.matfilter(c,fid)
	return c:GetFlagEffectLabel(m+100000000)==fid 
end
...
function cm.cpcon(e,tp,eg,ep,ev,re,r,rp)
	return rp==1-tp and not (re:IsHasType(EFFECT_TYPE_ACTIVATE) and re:IsActiveType(TYPE_PENDULUM)) and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED)
end
