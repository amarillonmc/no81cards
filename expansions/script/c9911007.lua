...
function c9911007.cfilter(c,tp,mc)
...
function c9911007.gselect(g,tp)
...
function c9911007.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.GetMatchingGroup(c9911007.cfilter,tp,LOCATION_HAND+LOCATION_MZONE+LOCATION_EXTRA,0,c,tp,c)
	if chk==0 then return g:CheckSubGroup(c9911007.gselect,2,2,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RELEASE)
	local rg=g:SelectSubGroup(tp,c9911007.gselect,false,2,2,tp)
	local label=0
	if rg:IsExists(c9911007.attfilter,2,nil) then label=1 end
