...
function c28315943.initial_effect(c)
	...
	e1:SetCountLimit(1,28315943-1)
	e1:SetCondition(c28315943.icon)
	...
	e0:SetCondition(c28315943.qcon)
	c:RegisterEffect(e0)
	--recover
