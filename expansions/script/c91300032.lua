...
function cm.initial_effect(c)
	...
	e1:SetCondition(c91300032.specon)
	e1:SetOperation(c91300032.speop)
	c:RegisterEffect(e1)
	--feilong
		--immune+count
	...
	e20:SetValue(c91300032.efilter)
	...
	e21:SetOperation(c91300032.flfcop)
	c:RegisterEffect(e21)
	local e22=e21:Clone()
	e22:SetCondition(c91300032.flfzcon)
	...
	e24:SetCondition(c91300032.rmhcon)
	e24:SetCost(c91300032.toexcost)
	e24:SetTarget(c91300032.rmhtg)
	e24:SetOperation(c91300032.rmhop)
	c:RegisterEffect(e24)
	local e25=e24:Clone()
	e25:SetCondition(c91300032.rmhconfz)
	...
	e4:SetCost(c91300032.rmmcost)
	e4:SetOperation(c91300032.rmmop)
	c:RegisterEffect(e4)
	--weizhi
	...
	e51:SetCondition(c91300032.con5)
	...
	e60:SetCondition(c91300032.jkfzcon)
	...
	e61:SetCondition(c91300032.jkfzcon)
	...
	e62:SetCondition(c91300032.jkfzcon)
	e62:SetOperation(c91300032.jkfcop)
	...
	e63:SetCondition(c91300032.jkfzcon)
	e63:SetOperation(c91300032.fdcop)
	...
	e64:SetCondition(c91300032.fzetcon)
	e64:SetCost(c91300032.toexcost)
	e64:SetOperation(c91300032.etop)
	...
	e70:SetCondition(c91300032.hdlfzcon)
	e70:SetValue(c91300032.tsefilter)
	...
	e71:SetCondition(c91300032.hdlfzcon)
	e71:SetOperation(c91300032.hdlfcop)
	...
	e72:SetCondition(c91300032.hdlfzcon)
	e72:SetOperation(c91300032.thcop)
	...
	e73:SetCondition(c91300032.fztgcon)
	e73:SetCost(c91300032.toexcost)
	e73:SetTarget(c91300032.tgtg)
	e73:SetOperation(c91300032.tgop)
...
function c91300032.tdfilter(c)
	return c.hackclad==1 and c:IsAbleToDeck()
end
function c91300032.speop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local g=c:GetOverlayGroup()
	if g:IsExists(c91300032.tdfilter,1,nil) then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
		local tg=g:FilterSelect(tp,c91300032.tdfilter,1,1,nil)
...
function c91300032.flfzcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetFlagEffectLabel(91301032)
end
function c91300032.flfcop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if eg:IsExists(c91300032.flfcopfilter,1,nil,tp) then
...
function c91300032.rmhcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local flag=c:GetFlagEffectLabel(91300032)
	return flag and flag>3
end
function c91300032.rmhconfz(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local flag=c:GetFlagEffectLabel(91300032)
...
function c91300032.rmhop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 and Duel.Remove(g,POS_FACEUP,REASON_EFFECT+REASON_TEMPORARY)~=0 then
			...
			e1:SetCountLimit(1)
			e1:SetCondition(c91300032.retcon)
			e1:SetOperation(c91300032.retop)
			Duel.RegisterEffect(e1,tp)
	end
end
function c91300032.retfilter(c)
	return c:GetFlagEffect(91302032)~=0
end
function c91300032.retcon(e,tp,eg,ep,ev,re,r,rp)
	local g=e:GetLabelObject():Filter(c91300032.retfilter,nil)
	return g:GetCount()>0
end
function c91300032.retop(e,tp,eg,ep,ev,re,r,rp)
	local g=e:GetLabelObject():Filter(c91300032.retfilter,nil)
	Duel.SendtoHand(g,nil,REASON_EFFECT)
end
function c91300032.rmmcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:IsAbleToExtraAsCost() end
	Duel.SendtoDeck(c,nil,SEQ_DECKTOP,REASON_COST)
end
function c91300032.rmmop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_FIELD)
	e2:SetTargetRange(0xff,0xff)
	e2:SetTarget(c91300032.rmmopfilter)
	e2:SetCode(EFFECT_CANNOT_DISABLE)
	e2:SetReset(RESET_PHASE+PHASE_END,2)
	Duel.RegisterEffect(e2,tp)
end
function c91300032.rmmopfilter(e,c)
...
function c91300032.jkfzcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetFlagEffectLabel(91301033)
end
function c91300032.jkfcopfilter(c,tp)
	return c:IsPreviousControler(1-tp)
end
function c91300032.jkfcop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if eg:IsExists(c91300032.jkfcopfilter,1,nil,tp) then
		c:AddCounter(0x1614,1)
		local flag=c:GetFlagEffectLabel(25824)
		if flag then
			c:SetFlagEffectLabel(25824,flag+1)
...
function c91300032.fdcop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c91300032.fzetcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local flag=c:GetFlagEffectLabel(91300033)
	return flag and flag>3 and c:GetFlagEffectLabel(91301033)
end
function c91300032.etop(e,tp,eg,ep,ev,re,r,rp)
...
function c91300032.hdlfzcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetFlagEffectLabel(91301034)
end
function c91300032.tsefilter(e,te,ev)
	return te:IsActiveType(TYPE_SPELL+TYPE_TRAP) and te:GetOwnerPlayer()~=e:GetHandlerPlayer()
end
function c91300032.hdlfcopfilter(c,tp)
	return c:IsPreviousLocation(LOCATION_DECK) and c:IsPreviousControler(1-tp)
end
function c91300032.hdlfcop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if eg:IsExists(c91300032.hdlfcopfilter,1,nil,tp) then
		c:AddCounter(0x1614,1)
		local flag=c:GetFlagEffectLabel(25824)
		if flag then
			c:SetFlagEffectLabel(25824,flag+1)
...
function c91300032.thcop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
