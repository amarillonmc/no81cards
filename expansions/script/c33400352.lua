...
function c33400352.filter(c,e,tp)
	return c:IsSetCard(0x341) and c:IsLevelBelow(8)
end
function c33400352.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		local mg=Duel.GetRitualMaterial(tp)  
		return Duel.IsExistingMatchingCard(aux.NecroValleyFilter(aux.RitualUltimateFilter),tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil,c33400352.filter,e,tp,mg,mg2,Card.GetLevel,"Greater")
	end
...
function c33400352.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local tg=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(aux.RitualUltimateFilter),tp,LOCATION_HAND+LOCATION_GRAVE,0,1,1,nil,c33400352.filter,e,tp,mg,mg2,Card.GetLevel,"Greater")
