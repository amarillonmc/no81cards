...
function c22348263.stfilter(c)
	return ((c:GetType()==0x20002 or c:GetType()==0x20004) and c:IsSetCard(0x570b) and Duel.GetLocationCount(tp,LOCATION_SZONE)>0 and Duel.IsEnvironment(22348260)) or (c:GetType()==0x80002 and c:IsCode(22348260)) and c:CheckActivateEffect(false,true,false)~=nil
end
