...
function c79029351.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(c79029351.splimit2)
	e1:SetLabelObject(c)
	...
	e2:SetOperation(c79029351.resop)
	c:RegisterEffect(e2) 
	--
	...
	e3:SetTarget(c79029351.splimit)
	...
	e0:SetDescription(aux.Stringid(79029351,8))
...
function c79029351.splimit(e,c,sump,sumtype,sumpos,targetp,se)
	return bit.band(sumtype,SUMMON_TYPE_RITUAL)~=SUMMON_TYPE_RITUAL
end  
function c79029351.splimit2(e,c,tp,sumtp,sumpos)
	return c~=e:GetLabelObject() 
end  
function c79029351.resop(e,tp,eg,ep,ev,re,r,rp)
...
function c79029351.poscost(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.IsExistingMatchingCard(c79029351.sefil,tp,LOCATION_HAND,0,1,nil) and Duel.CheckLPCost(tp,2000) end
