...
function c98920339.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	local lg=e:GetHandler():GetLinkedGroup()
	if chk==0 then return Duel.CheckReleaseGroup(tp,c98920339.cfilter,1,nil,lg) end
	local g=Duel.SelectReleaseGroup(tp,c98920339.cfilter,1,1,nil,lg)
