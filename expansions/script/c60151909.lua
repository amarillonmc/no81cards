...
function c60151909.initial_effect(c)
	...
	e7:SetCountLimit(1)
	e7:SetTarget(c60151909.e6tg)
	e7:SetOperation(c60151909.e6op)
	c:RegisterEffect(e7)
...
function c60151909.e1ope5f(e,re)
	return e:GetHandlerPlayer()~=re:GetOwnerPlayer()
end
function c60151909.e6tg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:IsCanTurnSet() end
	Duel.SetOperationInfo(0,CATEGORY_POSITION,c,1,0,0)
end
function c60151909.e6op(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
