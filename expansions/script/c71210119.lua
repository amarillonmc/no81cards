...
function s.exop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ct==3 and s.boostg(e,tp,eg,ep,ev,re,r,rp,0) then
		Duel.BreakEffect()
...
function s.boostg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.akfilter,tp,LOCATION_MZONE,0,1,nil)
		and Duel.SelectYesNo(tp,1113) end
end
function s.boostp(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(s.akfilter,tp,LOCATION_MZONE,0,nil)
