--星系级强者
function c72100108.initial_effect(c)
	---special summon
	c:EnableReviveLimit()
...
-----
function c72100108.filter(c)
	return c:IsFaceup() and c:IsType(TYPE_MONSTER)
end
function c72100108.defval(e,c)
	return Duel.GetMatchingGroupCount(c72100108.filter,c:GetControler(),LOCATION_GRAVE,0,nil)*900
end
