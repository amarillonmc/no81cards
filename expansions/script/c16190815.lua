...
function s.costfilter(c,tp)
	return c:IsRace(RACE_WARRIOR) and c:IsType(TYPE_LINK) and c:IsAbleToRemoveAsCost()
...
--	return c:IsSetCard(0xca0) and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsAbleToHand()
end
