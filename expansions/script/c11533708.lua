...
function c11533708.rycost(e,tp,eg,ep,ev,re,r,rp,chk) 
	if chk==0 then return e:GetHandler():IsAbleToDeckAsCost() and Duel.IsExistingMatchingCard(function(c) return c:IsAbleToDeckAsCost() and c:IsSetCard(0xb4,0x3a) and c:IsType(TYPE_MONSTER) end,tp,LOCATION_GRAVE+LOCATION_REMOVED,0,1,nil) end   
	local g=Duel.SelectMatchingCard(tp,function(c) return c:IsAbleToDeckAsCost() and c:IsSetCard(0xb4,0x3a) and c:IsType(TYPE_MONSTER) end,tp,LOCATION_GRAVE+LOCATION_REMOVED,0,1,1,nil) 
