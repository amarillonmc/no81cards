...
function c9330012.initial_effect(c)
	...
	e1:SetCondition(c9330012.condition)
...
function c9330012.cfilter(c)
	return c:IsFaceup() and c:IsOriginalCodeRule(9330001)
end
function c9330012.condition(e,tp,eg,ep,ev,re,r,rp)
	return not Duel.IsExistingMatchingCard(c9330012.cfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil)
end
