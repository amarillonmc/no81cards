...
--negate activate
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(98910026,0))
	e1:SetCategory(CATEGORY_DISABLE)
	e1:SetType(EFFECT_TYPE_QUICK_O)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1,98910126)
	e1:SetCode(EVENT_CHAINING)
	e1:SetCondition(c98910026.condition)
	e1:SetCost(c98910026.cost)
	e1:SetTarget(c98910026.target)
	e1:SetOperation(c98910026.operation)
	c:RegisterEffect(e1)
end
