...
function s.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(88884411,0))
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x893) and c:IsType(TYPE_MONSTER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
