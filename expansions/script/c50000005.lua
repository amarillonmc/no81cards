...
function cm.filter1(c)
	return c:IsFaceup() and c:IsCode(50000004,50000006)
end
...
function cm.filter(c,e,tp)
	return c:IsCode(50000007) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function cm.thfilter(c)
	return c:IsCode(50000004) and c:IsAbleToHand()
end
