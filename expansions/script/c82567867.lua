...
function c82567867.fusionfilter1(c)
	return c:IsSetCard(0x825) and c:IsLevelAbove(5) and c:IsLocation(LOCATION_MZONE)
end 
...
function c82567867.tgcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==1-tp and Duel.IsExistingMatchingCard(c82567867.FRIENDfilter,tp,LOCATION_MZONE,0,1,e:GetHandler())
end
