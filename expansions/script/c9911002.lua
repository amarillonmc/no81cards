...
function c9911002.cfilter(c,tp)
...
function c9911002.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.CheckReleaseGroupEx(tp,c9911002.cfilter,1,c,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_RELEASE)
	local g=Duel.SelectReleaseGroupEx(tp,c9911002.cfilter,1,1,c,tp)
	local label=0
	if g:IsExists(c9911002.attfilter,1,nil) then label=1 end
	e:SetLabel(label)
