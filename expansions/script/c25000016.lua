...
function cm.initial_effect(c)
	...
	local e3=rsef.FTO(c,EVENT_SPSUMMON_SUCCESS,{m,1},{1,m+200},"con,sp","de",LOCATION_HAND+LOCATION_GRAVE,cm.eqcon,rsgs.ToDeckCost(c),rsop.target2(cm.fun,cm.eqfilter,"con",0,LOCATION_MZONE),cm.eqop)
end
