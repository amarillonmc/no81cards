...
function cm.eqlimit(e,c)
	return c:IsRace(RACE_FIEND) or e:GetHandler():GetEquipTarget()==c
end
function cm.filter(c)
	local ct1,ct2=c:GetUnionCount()
	return c:IsFaceup() and c:IsRace(RACE_FIEND) and ct2==0
end
...
function cm.thfilter(c)
	return c:IsSetCard(0xcf30) and not c:IsCode(15004369) and c:IsAbleToHand()
end
