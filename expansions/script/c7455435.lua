...
function s.filter(c)
	return c:IsSetCard(0x10) and not c:IsCode(75878039) and c:IsAbleToHand()
end
...
function s.setfilter(c)
	return c:IsSetCard(0x10) and (c:IsType(TYPE_TRAP) or c:IsType(TYPE_SPELL)) and c:IsSSetable()
end
