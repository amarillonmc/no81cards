...
function s.spcon(e,c)
	...
	return Duel.IsCanRemoveCounter(tp,1,0,0x9f50,9,REASON_COST) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
end
function s.spop(e,tp,eg,ep,ev,re,r,rp,c)
	Duel.RemoveCounter(c:GetControler(),1,0,0x9f50,9,REASON_COST)
end
function s.winop(e,tp,eg,ep,ev,re,r,rp)
	local WIN_REASON_SATELLA=0xf5
