...
function c46260002.mfilter(c,e)
	return c:GetLevel()>0 and not c:IsImmuneToEffect(e) and c:IsReleasable() and c:IsFaceup()
end
function c46260002.mfilter2(c,e)
...
function c46260002.rop(e,tp,eg,ep,ev,re,r,rp)
	...
	local mg3=Duel.GetMatchingGroup(c46260002.mfilter2,tp,0,LOCATION_HAND,nil,e)
	mg1:Merge(mg3)
