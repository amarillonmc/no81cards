...
function c115766621.thop(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(c115766621.thfilter,tp,LOCATION_GRAVE,0,nil)
	if g:GetCount()==0 or not Duel.SelectYesNo(tp,aux.Stringid(115766621,1)) then return end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
