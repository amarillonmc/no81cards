...
function c60150722.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroupEx(REASON_COST,tp,c60150722.cfilter,1,nil) end
	local g=Duel.SelectReleaseGroupEx(REASON_COST,tp,c60150722.cfilter,1,1,nil)
