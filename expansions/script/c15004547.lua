...
function cm.spfilter(c,e,tp)
	return c:IsSetCard(0x5f41) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsCode(15004547)
end
...
function cm.tgfilter(c)
	return c:IsSetCard(0x5f41) and c:IsAbleToGrave() and c:IsType(TYPE_TRAP)
end
