...
function c79029225.dfil(c,e)
	return c:IsFaceup() and c:IsAttackBelow(e:GetHandler():GetAttack())
end
function c79029225.stgtarget(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsSummonType(SUMMON_TYPE_XYZ) and Duel.GetMatchingGroupCount(c79029225.dfil,tp,0,LOCATION_MZONE,nil,e)>=1 end
	local g=Duel.GetMatchingGroup(c79029225.dfil,tp,0,LOCATION_MZONE,nil,e)
	Duel.SetOperationInfo(0,CATEGORY_DESTROY,g,g:GetCount(),0,0)
end
function c79029225.stgoperation(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(c79029225.dfil,tp,0,LOCATION_MZONE,nil,e)
	local x=Duel.GetMatchingGroupCount(c79029225.dfil,tp,0,LOCATION_MZONE,nil,e)
