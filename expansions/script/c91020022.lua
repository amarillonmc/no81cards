...
function cm.drcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return  c:GetReasonCard():IsSetCard(0x9d0) and e:GetHandler():IsLocation(LOCATION_GRAVE) 
end
--e2
...
return ( c:IsAbleToHand() and c:IsSetCard(0x9d1)) or (Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false)and c:IsSetCard(0x9d1)) and c:IsType(TYPE_MONSTER) and c:IsFaceup()
end
