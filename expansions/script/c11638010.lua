...
function cm.con1(e,tp,eg,ep,ev,re,r,rp)
	...
	return re and re:IsActiveType(TYPE_SPELL+TYPE_TRAP) and re:GetHandler():GetControler()~=c:GetControler() and Duel.IsExistingMatchingCard(cm.ninjafilter,tp,LOCATION_MZONE,0,1,nil)
end
