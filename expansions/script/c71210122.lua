...
function s.exop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ct==4 and s.boostg(e,tp,eg,ep,ev,re,r,rp,0) then
		Duel.BreakEffect()
...
function s.boostg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(aux.TRUE,tp,0,LOCATION_ONFIELD,2,nil)
		and Duel.SelectYesNo(tp,aux.Stringid(20590515,2)) end
end
