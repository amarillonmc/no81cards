...
function c91000336.initial_effect(c)
	...
	return Duel.GetFieldGroupCount(e:GetHandlerPlayer(),LOCATION_EXTRA,0)==0 and (Duel.GetCurrentPhase()==PHASE_MAIN1 or Duel.GetCurrentPhase()==PHASE_MAIN2) end) 
...
function c91000336.rmcon(e,tp,eg,ep,ev,re,r,rp)
	...
	if not g:IsExists(c91000336.rmfilter,1,nil,e:GetLabel()) then
		g:DeleteGroup()
		e:Reset()
		return false
