...
function s.immop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x332b))
...
function s.spfilter(c,e,tp,lv)
	return c:IsSetCard(0x332b) and c:IsLevelBelow(lv) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.sfilter(c,e,tp,lv)
	return c:IsSetCard(0x332b) and c:IsLevel(lv) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
