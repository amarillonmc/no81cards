...
function c60153217.e2tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		return Duel.IsExistingMatchingCard(c60153217.e2tgf,tp,LOCATION_DECK,0,1,nil,e,tp)
			and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
			and Duel.IsExistingMatchingCard(c60153217.e2tgf,1-tp,LOCATION_DECK,0,1,nil,e,1-tp)
...
function c60153217.e2op(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local g=Duel.GetMatchingGroup(c60153217.e2tgf,tp,LOCATION_DECK,0,nil,e,tp)
	local g2=Duel.GetMatchingGroup(c60153217.e2tgf,1-tp,LOCATION_DECK,0,nil,e,tp)
