...
function cm.initial_effect(c)
	...
	function(e,tp,eg,ep,ev,re,r,rp)
		return Duel.IsChainNegatable(ev) and Duel.GetChainInfo(ev,CHAININFO_TRIGGERING_LOCATION)&LOCATION_ONFIELD>0
...
function cm.initial_effect(c)
	...
	e1:SetCondition(function(e,tp,eg,ep,ev,re,r,rp)
		...
		and Duel.IsChainNegatable(ev) and Duel.GetChainInfo(ev,CHAININFO_TRIGGERING_LOCATION)&LOCATION_ONFIELD>0
	end)
