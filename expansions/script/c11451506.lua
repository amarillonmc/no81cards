...
function cm.filter(c)
	return c:GetType()&0x4==0x4 and (c:IsFaceup() or c:IsLocation(LOCATION_GRAVE)) and c:CheckActivateEffect(false,true,false)~=nil and c:CheckActivateEffect(false,true,false):GetCode()==EVENT_CHAINING
end
