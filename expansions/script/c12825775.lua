...
function s.thfilter(c)
	return c:IsCode(12825760) and c:IsAbleToHand()
end
...
function s.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x3a76)
end
...
function s.spfilter(c,e,tp,mc)
	return c:IsSetCard(0x3a76) and mc:IsCanBeXyzMaterial(c) and c:IsType(TYPE_XYZ)
