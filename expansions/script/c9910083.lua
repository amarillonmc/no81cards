...
function c9910083.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 and g:IsExists(Card.IsRace,1,nil,RACE_FAIRY) then
		if g:IsExists(c9910083.thfilter,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(9910083,0)) then
		...
		if Duel.IsExistingMatchingCard(c9910083.spfilter,tp,LOCATION_HAND,0,1,nil,e,tp)
