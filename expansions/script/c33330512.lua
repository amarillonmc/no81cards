...
function c33330512.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(33330512,1))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_TOKEN)
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e1:SetRange(LOCATION_SZONE)
	e1:SetCode(EVENT_REMOVE)
	e1:SetCountLimit(1)
	e1:SetCondition(c33330512.con)
	e1:SetTarget(c33330512.tg)
	...
	e2:SetTarget(c33330512.retg)
	e2:SetTargetRange(0xff,0xff)
	e2:SetValue(LOCATION_REMOVED)
	c:RegisterEffect(e2)
end
function c33330512.confil(c,tp)
	return c:GetReasonPlayer()==tp and c:IsSetCard(0x5552)
end
function c33330512.con(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c33330512.confil,1,nil,tp)
end
function c33330512.tg(e,tp,eg,ep,ev,re,r,rp,chk)
