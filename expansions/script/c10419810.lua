...
function cm.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Destroy(eg,REASON_EFFECT)>0 then
		if Duel.GetLocationCount(1-tp,LOCATION_MZONE,tp)>0
			and Duel.IsPlayerCanSpecialSummonMonster(tp,10419706,0,TYPES_TOKEN_MONSTER,500,500,1,RACE_BEAST,ATTRIBUTE_EARTH,POS_FACEUP,1-tp) then
			local token=Duel.CreateToken(tp,10419706)
