...
function s.initial_effect(c)
	...
	e1:SetCategory(CATEGORY_TOHAND+CATEGORY_RECOVER+CATEGORY_DRAW+CATEGORY_DAMAGE)
...
function s.thfilter(c)
	return c:IsSetCard(0x9569) and (c:IsLocation(LOCATION_GRAVE) or c:IsFaceup()) and c:IsAbleToHand()
end
