...
function cm.initial_effect(c)
	...
	e1:SetOperation(function(e,tp,eg,ep,ev,re,r,rp)
		...
		if Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,nil,60000043) and Duel.SelectYesNo(tp,aux.Stringid(m,0)) then
			local g=Duel.SelectMatchingCard(tp,Card.IsCode,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,1,nil,60000043)
			Duel.SSet(tp,g)
		end
		local e1=Effect.CreateEffect(c)
