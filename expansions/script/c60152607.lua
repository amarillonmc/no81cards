--皇家骑士 梦狐
function c60152607.initial_effect(c)
    --xyz summon
    c:EnableReviveLimit()
    aux.AddXyzProcedureLevelFree(c,c60152607.auxfilter,nil,3,3)
    --spsummon condition
	...
	e01:SetCondition(c60152607.e01con)
	e01:SetOperation(c60152607.e01op)
    ...
    e1:SetCondition(c60152607.e1con)
	e1:SetTarget(c60152607.e1tar)
	e1:SetOperation(c60152607.e1op)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	e2:SetCode(EVENT_SPSUMMON_SUCCESS)
    e2:SetCountLimit(1,6012601)
	e2:SetCondition(c60152607.e2con)
	c:RegisterEffect(e2)
	--atk
    ...
    e3:SetCountLimit(1)
    e3:SetCondition(c60152607.e3con)
    e3:SetTarget(c60152607.e3tar)
    e3:SetOperation(c60152607.e3op)
    c:RegisterEffect(e3)
    local e4=e3:Clone()
    e4:SetDescription(aux.Stringid(60152602,2))
    e4:SetType(EFFECT_TYPE_QUICK_O)
    e4:SetCode(EVENT_FREE_CHAIN)
    e4:SetCondition(c60152607.e4con)
    c:RegisterEffect(e4)
	--tohand
    ...
    e5:SetCondition(c60152607.e5con)
    e5:SetTarget(c60152607.e5tar)
    e5:SetOperation(c60152607.e5op)
    c:RegisterEffect(e5)
    local e6=e5:Clone()
    e6:SetDescription(aux.Stringid(60152603,2))
    e6:SetType(EFFECT_TYPE_QUICK_O)
    e6:SetCode(EVENT_FREE_CHAIN)
    e6:SetCondition(c60152607.e6con)
    c:RegisterEffect(e6)
	--tograve
    ...
    e7:SetCondition(c60152607.e7con)
    e7:SetTarget(c60152607.e7tar)
    e7:SetOperation(c60152607.e7op)
    c:RegisterEffect(e7)
    local e8=e7:Clone()
    e8:SetCode(EVENT_SPSUMMON_SUCCESS)
    e8:SetCountLimit(1,6012604)
	e8:SetCondition(c60152607.e8con)
    c:RegisterEffect(e8)
    --indes
    ...
    e9:SetValue(1)
    e9:SetCondition(c60152607.e9con)
    c:RegisterEffect(e9)
    --indes2
    ...
    e10:SetValue(1)
    e10:SetCondition(c60152607.e10con)
    ...
    e13:SetCountLimit(1)
    e13:SetCondition(c60152607.e13con)
    e13:SetTarget(c60152607.e13tar)
    e13:SetOperation(c60152607.e13op)
    ...
    e14:SetValue(c60152607.e14val)
    e14:SetCondition(c60152607.e14con)
    ...
    e16:SetCountLimit(1)
    e16:SetCondition(c60152607.e16con)
    e16:SetTarget(c60152607.e16tar)
    e16:SetOperation(c60152607.e16op)
    ...
    e17:SetValue(c60152607.e17filter)
    e17:SetCondition(c60152607.e17con)
    ...
    e18:SetCondition(c60152607.e18con)
    e18:SetTarget(c60152607.e18tg)
    e18:SetOperation(c60152607.e18op)
    ...
    e19:SetCountLimit(1)
    e19:SetCondition(c60152607.e19con)
    e19:SetTarget(c60152607.e19tg)
    e19:SetOperation(c60152607.e19op)
    c:RegisterEffect(e19)
end
function c60152607.auxfilter(c,xyzc)
    return c:IsSetCard(0x6b27)
end
function c60152607.e01con(e,tp,eg,ep,ev,re,r,rp)
...
function c60152607.e01op(e,tp,eg,ep,ev,re,r,rp)
	local tp=e:GetHandlerPlayer()
	local c=e:GetHandler()
...
function c60152607.e1con(e,tp,eg,ep,ev,re,r,rp)
    return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152601)
end
function c60152607.e1tarfilter(c)
	return c:IsSetCard(0x6b27) and c:IsType(TYPE_MONSTER) and not c:IsCode(60152601) and c:IsAbleToHand()
end
function c60152607.e1tar(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c60152607.e1tarfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c60152607.e1opfilter(c,e,tp)
	return c:IsSetCard(0x6b27) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c60152607.e1op(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c60152607.e1tarfilter,tp,LOCATION_DECK,0,1,1,nil)
	if g:GetCount()>0 then
		Duel.SendtoHand(g,nil,REASON_EFFECT)
		Duel.ConfirmCards(1-tp,g)
		if e:GetHandler():GetColumnGroupCount()==0 then
			if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0 then return end
			local g=Duel.GetMatchingGroup(c60152607.e1opfilter,tp,LOCATION_GRAVE,0,nil,e,tp)
...
function c60152607.e2confilter(c)
	return c:IsFaceup() and c:IsSetCard(0x6b27) and c:IsType(TYPE_XYZ)
end
function c60152607.e2con(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c60152607.e2confilter,tp,LOCATION_MZONE,0,1,nil) 
		and e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152601)
end
function c60152607.e3con(e,tp,eg,ep,ev,re,r,rp)
    return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152602)
end
function c60152607.e3tar(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c60152607.e3op(e,tp,eg,ep,ev,re,r,rp)
    local c=e:GetHandler()
...
function c60152607.e4confilter(c)
    return c:IsFaceup() and c:IsSetCard(0x6b27) and c:IsType(TYPE_XYZ)
end
function c60152607.e4con(e,tp,eg,ep,ev,re,r,rp)
    return Duel.IsExistingMatchingCard(c60152607.e4confilter,tp,LOCATION_MZONE,0,1,nil) and e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152602)
end
function c60152607.e5con(e,tp,eg,ep,ev,re,r,rp)
    return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152603)
end
function c60152607.e5tar(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c60152607.e5op(e,tp,eg,ep,ev,re,r,rp)
    local tc=Duel.GetFirstTarget()
...
function c60152607.e6confilter(c)
    return c:IsFaceup() and c:IsSetCard(0x6b27) and c:IsType(TYPE_XYZ)
end
function c60152607.e6con(e,tp,eg,ep,ev,re,r,rp)
    return Duel.IsExistingMatchingCard(c60152607.e6confilter,tp,LOCATION_MZONE,0,1,nil) and e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152603)
end
function c60152607.e7con(e,tp,eg,ep,ev,re,r,rp)
    return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152604)
end
function c60152607.e7tarfilter(c)
    return c:IsSetCard(0x6b27) and not c:IsCode(60152604) and c:IsAbleToGrave()
end
function c60152607.e7tar(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then return Duel.IsExistingMatchingCard(c60152607.e7tarfilter,tp,LOCATION_DECK,0,1,nil) end
    Duel.SetOperationInfo(0,CATEGORY_TOGRAVE,nil,1,tp,LOCATION_DECK)
end
function c60152607.e7opfilter(c,e,tp)
	return c:IsSetCard(0x6b27) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c60152607.e7op(e,tp,eg,ep,ev,re,r,rp)
    Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
    local g=Duel.SelectMatchingCard(tp,c60152607.e7tarfilter,tp,LOCATION_DECK,0,1,1,nil)
    if g:GetCount()>0 then
        Duel.SendtoGrave(g,REASON_EFFECT)
		if e:GetHandler():GetColumnGroupCount()==0 then
			if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0 then return end
			local g=Duel.GetMatchingGroup(c60152607.e7opfilter,tp,LOCATION_HAND,0,nil,e,tp)
...
function c60152607.e8confilter(c)
	return c:IsFaceup() and c:IsSetCard(0x6b27) and c:IsType(TYPE_XYZ)
end
function c60152607.e8con(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c60152607.e8confilter,tp,LOCATION_MZONE,0,1,nil) and e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152604)
end
function c60152607.e9con(e,tp,eg,ep,ev,re,r,rp)
    return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152605)
end
function c60152607.e10con(e,tp,eg,ep,ev,re,r,rp)
    return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152606)
end
function c60152607.e11val(e,c)
    return c:GetOverlayCount()*300
end
function c60152607.e11con(e,tp,eg,ep,ev,re,r,rp)
    return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152607)
end
function c60152607.e13con(e,tp,eg,ep,ev,re,r,rp)
    local c=e:GetHandler()
    return (Duel.GetAttacker()==c or Duel.GetAttackTarget()==c)
end
function c60152607.e13tar(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c60152607.e13op(e,tp,eg,ep,ev,re,r,rp)
    local c=e:GetHandler()
    local tc=Duel.GetFirstTarget()
		...
		if e:GetHandler():GetColumnGroupCount()==0 then
			if Duel.Destroy(tc,REASON_EFFECT)>0 then
				...
				while tc do
					...
					e1:SetValue(c60152607.e13opaclimit)
...
function c60152607.e16op(e,tp,eg,ep,ev,re,r,rp)
    local c=e:GetHandler()
    local tc=Duel.GetFirstTarget()
    if c:IsRelateToEffect(e) and c:IsFaceup() and tc and tc:IsRelateToEffect(e)
		...
		if e:GetHandler():GetColumnGroupCount()==0 then
			...
			e1:SetValue(tp)
			e1:SetReset(RESET_EVENT+RESETS_STANDARD)
			e1:SetCondition(c60152607.e16opctcon)
			tc:RegisterEffect(e1)
			local e2=Effect.CreateEffect(c)
			e2:SetType(EFFECT_TYPE_SINGLE)
			...
			e2:SetReset(RESET_EVENT+RESETS_STANDARD)
			e2:SetCondition(c60152607.e16opctcon)
...
function c60152607.e16opctcon(e)
    local c=e:GetOwner()
    local h=e:GetHandler()
    return c:IsHasCardTarget(h)
end
function c60152607.e17filter(e,te)
    return te:IsActiveType(TYPE_SPELL+TYPE_TRAP)
end
function c60152607.e17con(e,tp,eg,ep,ev,re,r,rp)
    return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152609)
end
function c60152607.e18con(e,tp,eg,ep,ev,re,r,rp)
    local c=e:GetHandler()
    local bc=c:GetBattleTarget()
    return bc and bc:IsType(TYPE_TOKEN) and e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152609)
end
function c60152607.e18tg(e,tp,eg,ep,ev,re,r,rp,chk)
    if chk==0 then return true end
    Duel.SetOperationInfo(0,CATEGORY_DESTROY,e:GetHandler():GetBattleTarget(),1,0,0)
end
function c60152607.e18op(e,tp,eg,ep,ev,re,r,rp)
...
function c60152607.e19con(e,tp,eg,ep,ev,re,r,rp)
    return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,60152609)
end
function c60152607.e19tgfilter(c,tp)
...
function c60152607.e19tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
    if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(1-tp) and c60152607.e19tgfilter(chkc,tp) end
    if chk==0 then return Duel.GetLocationCount(1-tp,LOCATION_MZONE)>0
        and Duel.IsExistingTarget(c60152607.e19tgfilter,tp,0,LOCATION_MZONE,1,nil,tp) end
    Duel.SelectTarget(tp,c60152607.e19tgfilter,tp,0,LOCATION_MZONE,1,1,nil,tp)
    Duel.SetOperationInfo(0,CATEGORY_TOKEN,nil,1,0,0)
    Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,0,0)
end
function c60152607.e19op(e,tp,eg,ep,ev,re,r,rp)
    local c=e:GetHandler()
    local tc=Duel.GetFirstTarget()
