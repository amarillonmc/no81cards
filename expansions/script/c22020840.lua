...
function c22020840.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c22020840.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,nil)
end
function c22020840.spop(e,tp,eg,ep,ev,re,r,rp,c)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c22020840.spfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,1,nil)
