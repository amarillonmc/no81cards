...
function s.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b2=Duel.GetLocationCount(tp,LOCATION_SZONE)>0
		and Duel.IsExistingMatchingCard(s.eqfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil,c)
...
function s.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	local sel=aux.SelectFromOptions(tp,{b1,aux.Stringid(id,0)},{b2,aux.Stringid(id,1)})
	if sel==1 then
