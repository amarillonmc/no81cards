...
function c62501666.initial_effect(c)
	...
	--return hand
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(62501666,4))
	e3:SetCategory(CATEGORY_TOHAND)
	e3:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e3:SetCode(EVENT_CHAINING)
	e3:SetProperty(EFFECT_FLAG_DELAY)
	e3:SetRange(LOCATION_SZONE)
	e3:SetCountLimit(1,62501666+1)
	e3:SetCondition(c62501666.rtcon)
	e3:SetTarget(c62501666.rttg)
	e3:SetOperation(c62501666.rtop)
	c:RegisterEffect(e3)
end
c62501666.has_text_type=TYPE_SPIRIT
...
function c62501666.rtcon(e,tp,eg,ep,ev,re,r,rp)
	return rp==tp and re:GetHandler():IsSetCard(0xea2)
end
