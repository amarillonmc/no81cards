...
function cm.thfilter(c)
	return c:IsType(TYPE_CONTINUOUS) and c:IsType(TYPE_SPELL) and c:IsAbleToHand() and c:IsCanHaveCounter(0x625) and Duel.IsCanAddCounter(c:GetControler(),0x625,1,c)
end
