...
function c22348257.filter(c)
	return c:CheckActivateEffect(false,true,false)~=nil and ((c:GetType()==0x20002 and c:IsSetCard(0x570b) and Duel.GetLocationCount(tp,LOCATION_SZONE)>0) or (c:GetType()==0x20004 and c:IsSetCard(0x570b) and Duel.GetLocationCount(tp,LOCATION_SZONE)>0) or (c:GetType()==0x80002 and c:IsCode(22348260)))
end
