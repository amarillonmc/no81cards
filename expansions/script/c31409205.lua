...
function cm.initial_effect(c)
	...
	e2:SetCountLimit(1,100000000+m)
	e2:SetLabel(5)
	...
	e3:SetCountLimit(1,200000000+m)
	c:RegisterEffect(e3)
end
...
function cm.actop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ffcount>=3 and Duel.IsExistingMatchingCard(cm.actfilter,tp,LOCATION_DECK,0,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(m,0)) then
