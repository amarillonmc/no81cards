...
function c22021910.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(22021910,2))
	e4:SetCategory(CATEGORY_DESTROY)
	e4:SetType(EFFECT_TYPE_QUICK_O)
	e4:SetCode(EVENT_CHAINING)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCountLimit(1,22021911)
	e4:SetCondition(c22021910.erecon)
	e4:SetCost(c22021910.erecost)
	e4:SetTarget(c22021910.cetarget)
	e4:SetOperation(c22021910.ceoperation)
	c:RegisterEffect(e4)
end
...
function c22021910.erecon(e,tp,eg,ep,ev,re,r,rp)
	return ep~=tp and re:IsActiveType(TYPE_MONSTER) and Duel.IsExistingMatchingCard(Card.IsFaceup,0,LOCATION_FZONE,LOCATION_FZONE,1,nil) and Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22021910.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
