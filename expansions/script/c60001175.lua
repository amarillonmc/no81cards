...
function c60001175.damop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Damage(p,d,REASON_EFFECT)>0 and #g>0 and e:GetLabel()>0 and Duel.SelectYesNo(tp,aux.Stringid(60001175,2)) then
...
function c60001175.hsop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) then
		if Duel.SendtoHand(c,nil,REASON_EFFECT)>0 and Duel.IsExistingMatchingCard(c60001175.filter,tp,LOCATION_ONFIELD,0,1,nil,c) and #g>0 and Duel.SelectYesNo(tp,aux.Stringid(60001175,3)) then
