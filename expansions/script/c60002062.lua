...
local m=60002062
local cm=_G["c"..m]
cm.name="缇雅·雅莉珂希德：你如太阳一般耀眼"
cm.isTiaAlicosidr=true
...
function cm.costfilter(c)
	return c:IsAttack(3950) and c:IsType(TYPE_MONSTER) and (c:IsFaceup() or not c:IsLocation(LOCATION_MZONE)) and c:IsAbleToGraveAsCost()
end
