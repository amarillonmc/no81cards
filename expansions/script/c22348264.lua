...
function c22348264.cmfilter(c)
	return c:IsSetCard(0x70a3) and c:IsSummonable(true,nil)
end
...
function c22348264.opfilter(c,tp)
	return c:IsReason(REASON_BATTLE+REASON_EFFECT) and c:IsSetCard(0x70a3) and c:IsPreviousControler(tp)
...
function c22348264.spfilter(c,e,tp)
	return c:IsSetCard(0x70a3) and c:IsType(TYPE_DUAL) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
