...
function c22348264.cmfilter(c)
	return c:IsSetCard(0x370a) and c:IsSummonable(true,nil)
end
...
function c22348264.opfilter(c,tp)
	return c:IsReason(REASON_BATTLE+REASON_EFFECT) and c:IsSetCard(0x370a) and c:IsPreviousControler(tp)
