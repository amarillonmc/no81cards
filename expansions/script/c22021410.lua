...
function c22021410.filter(c,tp)
	return c:IsSetCard(0xaff1) and c:IsControler(tp) and c:IsSummonType(SUMMON_TYPE_LINK) and c:IsLinkBelow(1) and c:IsLinkAbove(1)
end
...
function c22021410.filter2(c,tp)
	return c:IsSetCard(0xaff1) and c:IsControler(tp) and c:IsSummonType(SUMMON_TYPE_LINK) and c:IsLinkBelow(2) and c:IsLinkAbove(2)
end
...
function c22021410.filter3(c,tp)
	return c:IsSetCard(0xaff1) and c:IsControler(tp) and c:IsSummonType(SUMMON_TYPE_LINK) and c:IsLinkBelow(3) and c:IsLinkAbove(3)
end
...
function c22021410.filter4(c,tp)
	return c:IsSetCard(0xaff1) and c:IsControler(tp) and c:IsSummonType(SUMMON_TYPE_LINK) and c:IsLinkBelow(4) and c:IsLinkAbove(4)
end
...
function c22021410.filter5(c,tp)
	return c:IsSetCard(0xaff1) and c:IsControler(tp) and c:IsSummonType(SUMMON_TYPE_LINK) and c:IsLinkBelow(5) and c:IsLinkAbove(5)
end
...
function c22021410.filter6(c,tp)
	return c:IsSetCard(0xaff1) and c:IsControler(tp) and c:IsSummonType(SUMMON_TYPE_LINK) and c:IsLinkBelow(6) and c:IsLinkAbove(6)
end
...
function c22021410.filter7(c,tp)
	return c:IsSetCard(0xaff1) and c:IsControler(tp) and c:IsSummonType(SUMMON_TYPE_LINK) and c:IsLinkBelow(7) and c:IsLinkAbove(7)
end
...
function c22021410.filter8(c,tp)
	return c:IsSetCard(0xaff1) and c:IsControler(tp) and c:IsSummonType(SUMMON_TYPE_LINK) and c:IsLinkBelow(8) and c:IsLinkAbove(8)
end
