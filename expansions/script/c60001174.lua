...
function c60001174.ckop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Draw(p,d,REASON_EFFECT)>0 and Duel.IsPlayerCanDraw(tp,1) and c:GetFlagEffect(60001168)>0 and c:IsLocation(LOCATION_SZONE) and Duel.IsPlayerCanDraw(tp,1) and Duel.SelectYesNo(tp,aux.Stringid(60001174,2)) then
