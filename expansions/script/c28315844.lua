...
function c28315844.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	c28315844.cost(e,tp,eg,ep,ev,re,r,rp,1)
...
function c28315844.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	return loc==LOCATION_MZONE and re:IsActiveType(TYPE_MONSTER)-- and p==tp--re:GetActivateLocation()
end
...
function c28315844.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if (ANTICA_EFFECT_HINT or e:GetHandler():IsReason(REASON_DESTROY)) and #g>0 then-- and Duel.SelectYesNo(p,aux.Stringid(28315844,2))
