--ACE
function c79034009.initial_effect(c)
	--pendulum summon
	...
	e2:SetCondition(c79034009.con)
	e2:SetTarget(c79034009.tg)
	e2:SetOperation(c79034009.op)
	c:RegisterEffect(e2)
end
function c79034009.con(e,tp,eg,ep,ev,re,r,rp)
...
function c79034009.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
	and e:GetHandler():IsCanBeSpecialSummoned(e,0,tp,false,false) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,e:GetHandler(),1,0,0)
end
function c79034009.op(e,tp,eg,ep,ev,re,r,rp)
