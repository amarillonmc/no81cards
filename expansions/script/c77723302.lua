...
function c77723302.initial_effect(c)
	c:SetUniqueOnField(1,0,77723302)
	--tohand
...
function c77723302.condition(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c77723302.cfilter1,1,nil,tp)
end
...
function c77723302.spcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c77723302.cfilter2,1,nil,tp) and not eg:IsContains(e:GetHandler())
end
