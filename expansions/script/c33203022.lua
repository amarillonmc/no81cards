--缝合僵尸 混沌侠
function c33203022.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	...
	e3:SetDescription(aux.Stringid(33203022,0))
	...
	e3:SetCountLimit(1)
	e3:SetTarget(c33203022.target)
	e3:SetOperation(c33203022.operation)
	c:RegisterEffect(e3)
end
function c33203022.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c33203022.operation(e,tp,eg,ep,ev,re,r,rp)
