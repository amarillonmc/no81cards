...
function c82567898.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(82567898,4))
	e4:SetType(EFFECT_TYPE_ACTIVATE)
	e4:SetCode(EVENT_FREE_CHAIN)
	e4:SetCountLimit(1,82567898)
	e4:SetCost(c82567898.cost)
	e4:SetTarget(c82567898.target4)
	e4:SetOperation(c82567898.activate4)
	c:RegisterEffect(e4)
	--Activate counter
