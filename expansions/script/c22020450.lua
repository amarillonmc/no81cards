...
function c22020450.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if dg:GetCount()>0 and dg1:GetCount()>0 and Duel.SelectOption(tp,aux.Stringid(22020450,1)) and Duel.SelectYesNo(tp,aux.Stringid(22020450,0)) then
		Duel.BreakEffect()
		Duel.SelectOption(tp,aux.Stringid(22020450,2))
