...
--[[local e12=Effect.CreateEffect(c) 
	...
	e10:SetDescription(aux.Stringid(11533717,3))
	e10:SetCategory(CATEGORY_ATKCHANGE)
	e10:SetType(EFFECT_TYPE_QUICK_O)
	e10:SetCode(EVENT_FREE_CHAIN) 
	e10:SetRange(LOCATION_HAND+LOCATION_MZONE)  
	e10:SetCountLimit(1,11553717) 
	e10:SetCost(c11533717.sscost)
	e10:SetOperation(c11533717.atkop)
...
function c11533717.atkvalfilter(c)
	return c:IsAttribute(ATTRIBUTE_WATER) and c:IsFaceupEx()
end
function c11533717.atkval(e,c)
	return Duel.GetMatchingGroupCount(c11533717.atkvalfilter,c:GetControler(),LOCATION_GRAVE+LOCATION_MZONE,0,nil)*300
end
