...
function c82557921.thfilter2(c)
	return c:IsRace(RACE_MACHINE) 
end
function c82557921.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c82557921.thfilter,tp,LOCATION_DECK,0,1,nil)
	   and Duel.IsExistingMatchingCard(c82557921.thfilter2,tp,LOCATION_MZONE,0,1,e:GetHandler()) end
