...
function s.dcon(e)
	...
	if d==nil then 
		return e:GetHandler() or e:GetHandler():GetColumnGroup():IsContains(a) 
	else
		return e:GetHandler() or e:GetHandler():GetColumnGroup():IsContains(a) or e:GetHandler():GetColumnGroup():IsContains(d)
	end
end
