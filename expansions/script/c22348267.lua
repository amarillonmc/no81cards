...
function c22348267.spfilter(c,e,tp)
	return c:IsSetCard(0x570b) and c:IsType(TYPE_MONSTER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEDOWN_DEFENSE)
end
...
function c22348267.xyzfilter2(c)
	return c:IsType(TYPE_MONSTER) and c:IsSetCard(0x570b) and c:IsCanOverlay()
end
