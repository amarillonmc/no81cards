...
function c22020740.sumsuc(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.SelectOption(tp,aux.Stringid(22020740,1))
	Duel.RegisterEffect(e1,tp)
end
function c22020740.atop(e,tp,eg,ep,ev,re,r,rp)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	Duel.SelectOption(tp,aux.Stringid(22020740,2))
	Duel.SelectOption(tp,aux.Stringid(22020740,3))
	Duel.SelectOption(tp,aux.Stringid(22020740,4))
	Duel.RegisterEffect(e1,tp)
end
