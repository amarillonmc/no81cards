...
function c9910037.initial_effect(c)
	...
	e4:SetCondition(c9910037.spcon)
	e4:SetCost(c9910037.spcost)
	e4:SetTarget(c9910037.sptg)
	e4:SetOperation(c9910037.spop)
	c:RegisterEffect(e4)
	--to hand
	...
	e5:SetTarget(c9910037.thtg)
	e5:SetOperation(c9910037.thop)
	c:RegisterEffect(e5)
end
...
function c9910037.spcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:IsPreviousLocation(LOCATION_ONFIELD) and c:IsPreviousPosition(POS_FACEUP) and c:IsReason(REASON_DESTROY)
end
function c9910037.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckLPCost(tp,1000) end
	Duel.PayLPCost(tp,1000)
end
function c9910037.spfilter(c,e,tp)
	return c:IsSetCard(0x3950) and c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c9910037.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c9910037.spfilter,tp,LOCATION_DECK,0,1,nil,e,tp) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_DECK)
end
function c9910037.spop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0 then return end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectMatchingCard(tp,c9910037.spfilter,tp,LOCATION_DECK,0,1,1,nil,e,tp)
