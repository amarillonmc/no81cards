...
function cm.eqtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetOperationInfo(0,CATEGORY_EQUIP,nil,1,0,0,LOCATION_GRAVE)
end
...
function cm.filter(c)
	return c:IsAttack(1320) and c:IsDefense(1450) and not c:IsAttribute(ATTRIBUTE_WATER) and not c:IsForbidden()
end
