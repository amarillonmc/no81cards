...
function s.descon1(e,tp,eg,ep,ev,re,r,rp)
	return re and re:GetHandler():GetCode()==40020485
end
...
function s.destg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(1-tp) and chkc:IsLocation(LOCATION_ONFIELD) and s.desfilter1(chkc) end
	if chk==0 then return Duel.IsExistingTarget(s.desfilter1,tp,0,LOCATION_ONFIELD,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
	local g=Duel.SelectTarget(tp,s.desfilter1,tp,0,LOCATION_ONFIELD,1,3,nil)
