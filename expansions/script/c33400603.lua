...
function cm.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,cm.spfilter,tp,LOCATION_HAND+LOCATION_REMOVED,0,1,1,e:GetHandler(),e,tp)
...
function cm.thfilter1(c)
	return c:IsSetCard(0x9342,0xc342) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
