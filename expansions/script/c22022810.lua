...
function c22022810.sumeop(e,tp,eg,ep,ev,re,r,rp)
	...
	if mchk3==1 then 
		if Duel.IsExistingMatchingCard(c22022810.spfil,1-tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil,e,tp) and Duel.GetLocationCount(1-tp,LOCATION_MZONE)>0 and Duel.SelectYesNo(1-tp,aux.Stringid(22022810,0)) then 
