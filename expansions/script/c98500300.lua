...
function c98500300.initial_effect(c)
	...
	e6:SetCondition(c98500300.descon)
	e6:SetTarget(c98500300.destg)
	e6:SetOperation(c98500300.desop)
	c:RegisterEffect(e6)
	--cannot trigger
	local e7=Effect.CreateEffect(c)
	e7:SetProperty(EFFECT_FLAG_CANNOT_INACTIVATE+EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_CAN_FORBIDDEN)
