...
function s.cxfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xc01) and not c:IsCode(id)
end
...
function s.filter(c,e,tp)
	return c:IsSetCard(0xc01) and not Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_GRAVE,0,1,nil,c:GetCode()) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
