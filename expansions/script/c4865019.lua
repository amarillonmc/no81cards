...
function cm.spreg(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsReason(REASON_COST) and rc:IsSetCard(0x332b) and c:IsPreviousLocation(LOCATION_ONFIELD) and re:IsActivated() then
...
function cm.eftg(e,c)
	...
	return c:IsType(TYPE_EFFECT) and c:IsSetCard(0x332b) and lg:IsContains(c)
end
