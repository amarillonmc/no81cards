...
function s.op2(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsChainDisablable(0) and Duel.IsExistingMatchingCard(Card.IsAbleToGrave,tp,LOCATION_MZONE,0,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(id,2)) then
	...
	local val=Duel.GetMatchingGroup(Card.IsFaceup,tp,LOCATION_MZONE,0,1,nil):GetSum(Card.GetAttack)
