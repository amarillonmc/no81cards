...
function cm.sptg(e, tp, eg, ep, ev, re, r, rp, chk)
	local g2 = Duel.GetMatchingGroup(cm.filter5, tp, LOCATION_DECK+LOCATION_GRAVE+LOCATION_REMOVED, 0, nil, e, tp)
...
function cm.desop(e, tp, eg, ep, ev, re, r, rp)
	local c = e:GetHandler()
	local g2 = Duel.SelectMatchingCard(tp, cm.filter5, tp, LOCATION_DECK+LOCATION_GRAVE+LOCATION_REMOVED, 0, 1, 1, nil, e, tp):GetFirst()
