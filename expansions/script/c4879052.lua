...
e4:SetLabelObject(e3)
	...
	e5:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0xae5f))
	c:RegisterEffect(e5)
end
...
function cm.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	return ft>0 and Duel.IsExistingMatchingCard(cm.filter,tp,LOCATION_GRAVE,0,1,nil) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and e:GetHandler():IsCanBeSpecialSummoned(e,0,tp,false,false) end
