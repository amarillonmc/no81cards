...
function s.initial_effect(c)
	...
	e4:SetCategory(CATEGORY_SSET+CATEGORY_TOHAND+CATEGORY_SPECIAL_SUMMON)
...
--●从卡组把这个卡名以外的1只「幻指」怪兽加入手卡。那之后，可以取除1个灵感指示物，从手卡把那只怪兽特殊召唤
function s.addfilter(c)
	return c.VHisc_HUANZHI and c:IsType(TYPE_MONSTER) and not c:IsCode(id) and c:IsAbleToHand()
end
