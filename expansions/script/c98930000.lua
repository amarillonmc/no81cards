...
function c98930000.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(98930000,1))
	...
	--to grave
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(98930000,0))
	e3:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e3:SetProperty(EFFECT_FLAG_DELAY)
	e3:SetCode(EVENT_TO_GRAVE)
	e3:SetCountLimit(1,98990000)
	e3:SetTarget(c98930000.tgtg)
	e3:SetOperation(c98930000.tgop)
	c:RegisterEffect(e3)
end
...
function c98930000.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(c98930000.splimit)
...
function c98930000.splimit(e,c,sump,sumtype,sumpos,targetp,se)
