...
function c71000172.initial_effect(c)
	...
	e4:SetTarget(c71000172.splimit)
	c:RegisterEffect(e4)
end
function c71000172.splimit(e,c,sump,sumtype,sumpos,targetp,se)
