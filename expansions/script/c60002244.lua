...
function cm.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if Art_g:GetClassCount(Card.GetCode)<7 then
...
function cm.filter1(c,e,tp)
	return c:IsCode(60002234) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function cm.filter2(c,e,tp)
	return c:IsCode(60002235) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function cm.filter3(c,e,tp)
	return c:IsCode(60002236) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
