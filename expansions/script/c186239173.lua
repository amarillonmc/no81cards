...
function s.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcCodeFun(c,50834074,s.matfilter,1,true,true)
	--move field
...
function s.pfilter(c,tp)
	return not c:IsForbidden() and c:IsType(TYPE_FIELD) and c:CheckUniqueOnField(tp) and c:IsCanPlaceInFieldZone(tp,tp)
end
