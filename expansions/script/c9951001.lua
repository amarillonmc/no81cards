...
function c9951001.initial_effect(c)
	--xyz summon
	aux.AddXyzProcedure(c,nil,11,2,c9951001.ovfilter,aux.Stringid(9951001,0),2)
	c:EnableReviveLimit()
 --handes
	local e7=Effect.CreateEffect(c)
	e7:SetDescription(aux.Stringid(9951001,1))
  ...
  --negate
	...
	e1:SetDescription(aux.Stringid(9951001,2))
...
function c9951001.ovfilter(c)
	local rk=c:GetRank()
	return c:IsFaceup() and c:GetOverlayCount()>=2 and c:IsType(TYPE_XYZ) and c:IsRace(RACE_DRAGON) and rk>=9 and rk<=10
end
