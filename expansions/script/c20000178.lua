...
--e1
function cm.e1(c)
	fuef.A(c):CAT("NEGE"):PRO("TG"):Func("tg1,op1")
end
...
function cm.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	local e1 = fuef.S(e,EFFECT_DISABLE,tc):RES("EV+STD+PH/ED")(EFFECT_MUST_ATTACK)
	...
	Duel.BreakEffect()
	e1(EFFECT_CANNOT_TRIGGER,g):DES(0):PRO("HINT"):RES("EV+STD+PH/ED|2")
end