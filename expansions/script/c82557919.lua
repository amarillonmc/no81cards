...
function c82557919.initial_effect(c)
	...
	e1:SetTarget(c82557919.psplimit)
	c:RegisterEffect(e1)
	...
	e3:SetDescription(aux.Stringid(82557919,0))
	e3:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e3:SetType(EFFECT_TYPE_SINGLE)
	e3:SetCode(EFFECT_SUMMON_PROC)
	e3:SetRange(LOCATION_HAND)
	e3:SetCondition(c82557919.ntcon2)
	c:RegisterEffect(e3)
	--control
...
function c82557919.psplimit(e,c,tp,sumtp,sumpos)
...
function c82557919.ntcon2(e,c,minc)
	if c==nil then return true end
