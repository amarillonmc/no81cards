...
function cm.initial_effect(c)
	...
	e1:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH+CATEGORY_TOGRAVE+CATEGORY_COUNTER+CATEGORY_DRAW)
...
function cm.filter(c)
	return aux.IsCodeListed(c,60000179) and not c:IsCode(m) and c:IsAbleToHand()
end
