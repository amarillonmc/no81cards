...
function c60150626.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(60150626,0))
...
function c60150626.ffilter2(c)
	return (c:IsSetCard(0x3b21) and c:IsAttribute(ATTRIBUTE_DARK)) or c:IsHasEffect(60150643)
end
...
function c60150626.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c60150626.cfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,0,1,nil) end
	local g=Duel.GetMatchingGroup(c60150626.cfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,0,nil)
