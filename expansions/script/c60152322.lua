...
function c60152322.e2tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.IsExistingTarget(c60152322.e2tgfilter,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,nil,e) 
...
function c60152322.e2op(e,tp,eg,ep,ev,re,r,rp)
	...
	if g0:GetCount()>0 then
		Duel.Hint(HINT_SELECTMSG,tp,aux.Stringid(60152301,6))
		local g1=Duel.SelectMatchingCard(tp,c60152322.e2tgfilter,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,1,nil,e)
