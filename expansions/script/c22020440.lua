...
function c22020440.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(22020440,3))
	e3:SetType(EFFECT_TYPE_QUICK_O)
	e3:SetRange(LOCATION_GRAVE)
	e3:SetCode(EVENT_SPSUMMON_SUCCESS)
	e3:SetCountLimit(1,22020441)
	e3:SetCondition(c22020440.spcon1)
	e3:SetCost(c22020440.erecost)
	e3:SetTarget(c22020440.pentg)
	e3:SetOperation(c22020440.penop)
	c:RegisterEffect(e3)
end
...
function c22020440.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SelectOption(tp,aux.Stringid(22020440,2))
...
function c22020440.spcon1(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c22020440.cfilter,1,nil,tp) and Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22020440.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
