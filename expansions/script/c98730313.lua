...
function c98730313.spfilter(c,e,tp)
	return c:IsRace(RACE_DRAGON) and c:IsAttribute(ATTRIBUTE_FIRE) and c:IsFaceup() and c:IsCanBeSpecialSummoned(e,nil,tp,false,false) and c:GetOriginalLevel()>0
end
function c98730313.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c98730313.spfilter,tp,LOCATION_EXTRA,0,1,nil,e,tp) and Duel.GetLocationCountFromEx(g)>0 end
