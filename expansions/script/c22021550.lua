...
function c22021550.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(REASON_COST,tp,Card.IsCode,1,nil,22021540) end
	local g=Duel.SelectReleaseGroup(REASON_COST,tp,Card.IsCode,1,1,nil,22021540)
