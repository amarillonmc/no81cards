...
function c98930407.initial_effect(c)
	...
	c:RegisterEffect(e1)	
	local e10=e1:Clone()
	e10:SetDescription(aux.Stringid(98930407,8))
	e10:SetRange(LOCATION_DECK)
	e10:SetCondition(c98930407.con1)
	e10:SetCost(c98930407.cost)
	...
	e30:SetTarget(c98930407.actarget)
	e30:SetOperation(c98930407.costop)
...
function c98930407.actarget(e,te,tp)
	e:SetLabelObject(te)
	return te:GetHandler()==e:GetHandler()
end
function c98930407.costop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetOperation(c98930407.rsop)
...
function c98930407.rsop(e,tp,eg,ep,ev,re,r,rp)
