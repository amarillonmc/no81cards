...
function c95102011.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(95102011,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_FUSION_SUMMON)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_SZONE)
	e2:SetCountLimit(1,95102011)
	e2:SetTarget(c95102011.target)
	e2:SetOperation(c95102011.activate)
	c:RegisterEffect(e2)
end
...
function c95102011.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		local chkf=tp
...
function c95102011.activate(e,tp,eg,ep,ev,re,r,rp)
	local chkf=tp
