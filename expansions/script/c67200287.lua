...
function c67200287.spcon(e,c)
	...
	return Duel.IsExistingMatchingCard(c67200287.spfilter1,tp,LOCATION_ONFIELD,0,1,nil,tp) and ((c:IsLocation(LOCATION_HAND) and Duel.GetLocationCount(tp,LOCATION_MZONE)>-1) or
...
function c67200287.spop(e,tp,eg,ep,ev,re,r,rp,c)
	...
	local g=Duel.SelectMatchingCard(tp,c67200287.spfilter1,tp,LOCATION_ONFIELD,0,1,1,nil,tp)
