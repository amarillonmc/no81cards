...
function c9950120.initial_effect(c)
	...
	e1:SetTarget(c58616392.target2)
	e1:SetOperation(c58616392.operation2)
	c:RegisterEffect(e1)
	--spsummon bgm
...
function c9950120.filter(c,e,tp)
...
function c9950120.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_DECK+LOCATION_GRAVE+LOCATION_REMOVED) and chkc:IsControler(tp) and c9950120.filter(chkc,e,tp) end
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c9950120.filter,tp,LOCATION_DECK+LOCATION_GRAVE+LOCATION_REMOVED,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c9950120.filter,tp,LOCATION_DECK+LOCATION_GRAVE+LOCATION_REMOVED,0,1,1,nil,e,tp)
...
function c58616392.target2(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c58616392.operation2(e,tp,eg,ep,ev,re,r,rp)
