...
function s.movefilter(c)
	...
	return seq<=4 and seq>0 and c:IsCode(12835101) and c:IsFaceup() and Duel.CheckLocation(tp,LOCATION_MZONE,seq-1)
end
...
function s.efilter(e,te)
	return te:IsActivated() and te:IsActiveType(TYPE_SPELL) and te:GetOwnerPlayer()~=e:GetHandlerPlayer()
end