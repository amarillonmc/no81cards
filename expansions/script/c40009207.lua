...
function c40009207.tdop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.Remove(tc,0,REASON_EFFECT+REASON_TEMPORARY)>0 then
		...
		local g=Duel.SelectMatchingCard(tp,c40009207.filter3,tp,0,LOCATION_ONFIELD,1,1,nil)
...
function c40009207.negcon(e,tp,eg,ep,ev,re,r,rp)
	return not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED) and ep~=tp and Duel.IsChainNegatable(ev) and Duel.GetTurnPlayer()==e:GetHandlerPlayer()
end
