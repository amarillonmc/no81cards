...
function cm.initial_effect(c)
	...
	--count
		...
		e5:SetCondition(c22348199.checkcon)
		e5:SetOperation(c22348199.checkop)
		c:RegisterEffect(e5)
end
...
function c22348199.spop2(e,tp,eg,ep,ev,re,r,rp)
	...
	local gg=ag:Filter(c22348199.thhfilter,nil,re)
	local c=e:GetHandler()
	if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)~=0 and gg:GetCount()~=0 and Duel.SelectYesNo(tp,aux.Stringid(22348199,3)) then
		Duel.BreakEffect()
...
function c22348199.descon2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsPlayerAffectedByEffect(tp,22348205) and not (e:GetHandler():GetFlagEffect(22348199)>0)
end
