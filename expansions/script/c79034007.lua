--令人敬佩的觉悟-梅菲斯特
function c79034007.initial_effect(c)
	--pendulum summon
	...
	e1:SetOperation(c79034007.operation)
	c:RegisterEffect(e1)   
	--atk up
	local e1=Effect.CreateEffect(c)
	...
	e1:SetRange(LOCATION_PZONE)
	e1:SetCountLimit(1,79034007)
	e1:SetCost(c79034007.cost)
	e1:SetTarget(c79034007.tg)
	e1:SetOperation(c79034007.op)
	c:RegisterEffect(e1)
end
function c79034007.operation(e,tp,eg,ep,ev,re,r,rp)
	if ep==tp then return end
	Duel.Recover(tp,500,REASON_EFFECT)
end
function c79034007.cost(e,tp,eg,ep,ev,re,r,rp,chk)
