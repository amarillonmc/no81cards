...
function cm.thfilter(c)
	return c:IsSetCard(0xcf38) and c:IsType(TYPE_SPELL) and c:IsAbleToHand()
end
...
function cm.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b2=(Duel.IsExistingMatchingCard(cm.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) and not bcode)
