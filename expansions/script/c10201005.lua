--机械矩阵
function c10201005.initial_effect(c)
	--Activate
	...
	e2g:SetCondition(c10201005.gravecon)
	...
	e3:SetTarget(c10201005.sumlimit)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
