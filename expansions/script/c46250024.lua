...
function c46250024.sxfilter(c,mg)
	return c:CheckFusionMaterial(mg,nil) or c:IsXyzSummonable(mg,2,2)
end
function c46250024.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if not Duel.IsPlayerAffectedByEffect(tp,59822133)
		...
		if Duel.GetLocationCountFromEx(tp,tp,sg1)>0 and sxg:GetCount()>0 and Duel.SelectYesNo(tp,aux.Stringid(46250024,0)) then
			Duel.BreakEffect()
			Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
