...
function cm.initial_effect(c)
	...
	local e2 = rsef.I(c,"sp",{1,m},"sp",nil,LOCATION_MZONE,cm.spcon,rscost.cost(cm.resfilter,"res"),rsop.target(cm.spfilter,"sp",LOCATION_GRAVE),cm.spop)
end
...
function cm.spop(e,tp)
	rsop.SelectSpecialSummon(tp,aux.NecroValleyFilter(cm.spfilter2),tp,LOCATION_GRAVE,0,1,1,nil,{},e,tp)
end