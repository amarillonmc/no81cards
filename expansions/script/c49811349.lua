...
function s.spop(e,tp,eg,ep,ev,re,r,rp,c)
	...
	c:RegisterFlagEffect(id+100,RESET_EVENT+RESETS_STANDARD-RESET_TOFIELD+RESET_PHASE+PHASE_END,0,1,fid)
	local e1=Effect.CreateEffect(c)
...
function s.aclimit(e,re,tp)
	...
	return not (re:GetHandler()==c and c:GetFlagEffectLabel(id+100)==e:GetLabel())
end
