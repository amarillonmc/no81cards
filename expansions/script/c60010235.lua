...
function cm.atg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(tp) and chkc:IsLocation(LOCATION_GRAVE) and cm.afil(chkc,e) end
	local g=Duel.GetMatchingGroup(cm.afil,tp,LOCATION_GRAVE,0,nil,e)
