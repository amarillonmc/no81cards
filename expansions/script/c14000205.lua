...
cm.lvdncount=4
cm.lvdn={14000201,14000202,14000203,14000204}
...
function cm.negcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:GetFlagEffect(14000204)~=0 and Duel.IsChainNegatable(ev) and re:GetHandler()~=e:GetHandler() and not c:IsStatus(STATUS_BATTLE_DESTROYED)
end
