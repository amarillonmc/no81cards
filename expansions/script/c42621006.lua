...
function cm.drval(e)
	local tp=e:GetHandlerPlayer()
	return (Duel.GetFlagEffect(1-tp,107000090+Duel.GetTurnCount()-1)//3)+1
end

function cm.negcon(e,tp,eg,ep,ev,re,r,rp)
	return rp==1-tp and Duel.GetFlagEffect(tp,m+1)<Duel.GetFlagEffect(1-tp,107000090+Duel.GetTurnCount()-1)//4
end
