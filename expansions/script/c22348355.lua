...
function c22348355.cee3con(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c22348355.cfilter3,1,e:GetHandler(),tp)
end
...
function c22348355.cee2con(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c22348355.cfilter,1,nil,1-tp)
end
...
function c22348355.thcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c22348355.thconfilter,1,nil,1-tp)
end
