...
function cm.initial_effect(c)
	...
	e1:SetCountLimit(1,31430104+EFFECT_COUNT_CODE_OATH)
...
function cm.rfilter(c)
	return c:IsSetCard(0xc311) and c:IsType(TYPE_EFFECT)
end
...
function cm.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc then
		...
		e1:SetDescription(aux.Stringid(31430104,0))
		...
		local e3=e1:Clone()
		e3:SetDescription(aux.Stringid(31430104,1))
