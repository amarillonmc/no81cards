...
function c22020680.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(22020680,3))
	e5:SetCategory(CATEGORY_DESTROY)
	e5:SetType(EFFECT_TYPE_IGNITION)
	e5:SetRange(LOCATION_GRAVE)
	e5:SetCountLimit(1)
	e5:SetCondition(c22020680.erescon)
	e5:SetCost(c22020680.erecost)
	e5:SetTarget(c22020680.destg)
	e5:SetOperation(c22020680.desop)
	c:RegisterEffect(e5)
end
...
function c22020680.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SelectOption(tp,aux.Stringid(22020680,1))
end
...
function c22020680.descost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SelectOption(tp,aux.Stringid(22020680,2))
end
function c22020680.spcon2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()~=tp
end
function c22020680.erescon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22020680.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
