...
function c9910362.acttg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFlagEffect(tp,9910362)==0
		and Duel.IsExistingMatchingCard(c9910362.actfilter,tp,LOCATION_HAND+LOCATION_DECK,0,1,nil,tp) end
	Duel.RegisterFlagEffect(tp,9910362,RESET_CHAIN,0,1)
...
function c9910362.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetFlagEffect(tp,9910362)==0 and Duel.GetLocationCount(tp,LOCATION_SZONE)>0
