...
function s.filterc3(c,lv,e,tp,recursive)
	return c:IsRankBelow(lv-1) and c:IsSetCard(0x716) and c:IsType(TYPE_XYZ)
...
function s.op3(e,tp,eg,ep,ev,re,r,rp)
	if not aux.MustMaterialCheck(nil,tp,EFFECT_MUST_BE_XMATERIAL)
		or Duel.IsPlayerAffectedByEffect(tp,59822133)
		or Duel.GetLocationCountFromEx(tp,tp,nil,TYPE_XYZ)<2 then return end
