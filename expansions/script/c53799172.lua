...
function cm.counterfilter(c)
	return c:IsAttribute(ATTRIBUTE_WATER) and (not c:IsSummonLocation(LOCATION_EXTRA) or c:IsType(TYPE_LINK))
end
...
function cm.splimit(e,c,sump,sumtype,sumpos,targetp,se)
	return not c:IsAttribute(ATTRIBUTE_WATER) or (not c:IsType(TYPE_LINK) and c:IsLocation(LOCATION_EXTRA))
end
