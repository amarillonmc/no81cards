...
function cm.operation1(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetOperation(cm.operation13)
	e1:SetReset(RESET_PHASE+PHASE_END) 
	Duel.RegisterEffect(e1,tp)
end
function cm.operation13(e,tp,eg,ep,ev,re,r,rp)
	e:Reset()
...
function cm.operation2(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCode(EVENT_ADJUST)
	e1:SetLabelObject(e:GetLabelObject())
	e1:SetOperation(cm.operation23)
	e1:SetReset(RESET_PHASE+PHASE_END) 
	Duel.RegisterEffect(e1,tp)
end
function cm.operation23(e,tp,eg,ep,ev,re,r,rp)
	e:Reset()
	Duel.Hint(HINT_CARD,0,m)
...
function cm.operation3(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCode(EVENT_ADJUST)
	e1:SetLabelObject(e:GetLabelObject())
	e1:SetOperation(cm.operation33)
	e1:SetReset(RESET_PHASE+PHASE_END) 
	Duel.RegisterEffect(e1,tp)
end
function cm.operation33(e,tp,eg,ep,ev,re,r,rp)
	e:Reset()
	Duel.Hint(HINT_CARD,0,m)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
...
function cm.condition4(e,tp,eg,ep,ev,re,r,rp)
	local g=eg:Filter(cm.cfilter4,nil,e,1-tp)
...
function cm.operation4(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCode(EVENT_ADJUST)
	e1:SetLabelObject(e:GetLabelObject())
	e1:SetOperation(cm.operation43)
	e1:SetReset(RESET_PHASE+PHASE_END) 
	Duel.RegisterEffect(e1,tp)
end
function cm.operation43(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,m)
...
function cm.operation5(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCode(EVENT_ADJUST)
	e1:SetLabelObject(e:GetLabelObject())
	e1:SetOperation(cm.operation53)
	e1:SetReset(RESET_PHASE+PHASE_END) 
	Duel.RegisterEffect(e1,tp)
end
function cm.operation53(e,tp,eg,ep,ev,re,r,rp)
	e:Reset()
	Duel.Hint(HINT_CARD,0,m)
...
function cm.operation6(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCode(EVENT_ADJUST)
	e1:SetLabelObject(e:GetLabelObject())
	e1:SetOperation(cm.operation63)
	e1:SetReset(RESET_PHASE+PHASE_END) 
	Duel.RegisterEffect(e1,tp)
end
function cm.operation63(e,tp,eg,ep,ev,re,r,rp)
	e:Reset()
	Duel.Hint(HINT_CARD,0,m)
