...
function c40009190.settg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c40009190.setfilter,tp,LOCATION_DECK,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c40009190.setfilter,tp,LOCATION_DECK,0,1,1,nil,e,tp)
...
function c40009190.filter1(c,e,tp)
	...
	return c:IsFaceup() and c:IsSetCard(0xf1c)
		and Duel.IsExistingMatchingCard(c40009190.filter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,c,rk+1)
