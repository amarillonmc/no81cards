--召引坏兽 摩斯拉
local cm,m=GetID()
function c91010032.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(54334420,0))
...
function cm.thfilter(c)
	return c:IsLevelAbove(5) and c:IsSetCard(0xd3) and c:IsAbleToHand() and c:IsType(TYPE_MONSTER)
end
