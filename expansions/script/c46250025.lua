...
function c46250025.initial_effect(c)
	...
	for i=1,12 do
		...
		e1:SetCondition(aux.XyzCondition(aux.FilterBoolFunction(Card.IsSetCard,0x1fc0),i,2,2))
		e1:SetTarget(aux.XyzTarget(aux.FilterBoolFunction(Card.IsSetCard,0x1fc0),i,2,2))
		e1:SetOperation(aux.XyzOperation(aux.FilterBoolFunction(Card.IsSetCard,0x1fc0),i,2,2))
