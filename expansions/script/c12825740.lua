...
function s.filter1(c)
	return c:IsFaceup() and c:IsSetCard(0x3a76) and not c:IsCode(12825715)
end
function s.filter2(c)
	return c:IsCode(12825715)
end
function s.cfilter(c)
	return c:IsFaceup() and c:IsCode(12825715)
end
...
function s.setfilter(c)
	return c:IsSetCard(0x3a76) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsSSetable()
end
