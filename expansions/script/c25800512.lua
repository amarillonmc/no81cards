...
function cm.spfilter(c,e,tp)
	return c:IsCode(25800156) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function cm.filter(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0xa212) and c:IsType(TYPE_MONSTER)
...
function cm.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SelectTarget(tp,cm.filter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,1,e:GetHandler(),e,tp)
