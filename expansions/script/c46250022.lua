...
function c46250022.initial_effect(c)
	...
	e1:SetTarget(aux.RPGTarget(aux.FilterBoolFunction(Card.IsType,TYPE_RITUAL)))
	e1:SetOperation(aux.RPGOperation(aux.FilterBoolFunction(Card.IsType,TYPE_RITUAL)))
	c:RegisterEffect(e1)
	local e2=e1:Clone()
