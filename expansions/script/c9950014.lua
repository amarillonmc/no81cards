...
function c9950014.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(9950014,0))
	e1:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_HAND)
	e1:SetCost(c9950014.thcost)
	e1:SetTarget(c9950014.thtg)
	e1:SetOperation(c9950014.thop)
	c:RegisterEffect(e1)
	--search
...
function c9950014.thfilter(c)
	return c:IsCode(9950015) and c:IsAbleToHand()
end
function c9950014.thtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.IsExistingMatchingCard(c9950014.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c9950014.thop(e,tp,eg,ep,ev,re,r,rp,chk)
	local tg=Duel.GetFirstMatchingCard(c9950014.thfilter,tp,LOCATION_DECK,0,nil)
	if tg then
...
function c9950014.thop2(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
		...
		Duel.Hint(HINT_MUSIC,0,aux.Stringid(9950014,3))
	end
end
