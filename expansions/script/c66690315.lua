...
function s.initial_effect(c)
	...
	-- ●以自己的墓地·除外状态的3张「蒸汽朋克」卡为对象才能发动，那些卡回到卡组，那之后，自己抽1张
	...
	-- ●把手卡的念动力族怪兽任意数量给对方观看，回到卡组洗切，那之后，自己从卡组抽出回到卡组的数量
...
-- ●把手卡的念动力族怪兽任意数量给对方观看，回到卡组洗切，那之后，自己从卡组抽出回到卡组的数量
function s.filter(c)
	return c:IsRace(RACE_PSYCHO) and c:IsAbleToDeck() and not c:IsPublic()
end
