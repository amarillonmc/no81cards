...
function c95102001.tg1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_SZONE)>0
		and Duel.IsExistingMatchingCard(c95102001.filter1,tp,LOCATION_HAND+LOCATION_DECK,0,1,nil,tp) end
end
function c95102001.op1(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_SZONE)<=0 then return end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOFIELD)
	local tc=Duel.SelectMatchingCard(tp,c95102001.filter1,tp,LOCATION_HAND+LOCATION_DECK,0,1,1,nil,tp):GetFirst()
