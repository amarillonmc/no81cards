...
function c40008564.descon4(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnCount()-e:GetLabel()==6
end
function c40008564.damop4(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_MESSAGE,1-tp,aux.Stringid(40008564,0))
	Duel.Hint(HINT_MESSAGE,tp,aux.Stringid(40008564,0))
	Duel.Win(1-tp,nil)
end
