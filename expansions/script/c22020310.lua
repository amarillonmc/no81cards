...
c22020310.effect_with_master=true
...
function c22020310.xfilter1(c,e,tp)
	...
	return rk>0 and c:IsFaceup() and c:IsSetCard(0x6ff1)
...
function c22020310.xfilter2(c,e,tp,mc,rk)
	return c:GetAttack()==rk and c:IsAttribute(ATTRIBUTE_DARK) and c:IsSetCard(0x6ff1) and mc:IsCanBeXyzMaterial(c) and c:IsType(TYPE_XYZ)
