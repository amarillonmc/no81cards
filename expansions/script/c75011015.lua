...
function c75011015.initial_effect(c)
	...
	e0:SetCountLimit(1,75011015)
	e0:SetCondition(c75011015.spcon1)
	e0:SetCost(c75011015.spcost)
	e0:SetTarget(c75011015.sptg)
	e0:SetOperation(c75011015.spop)
	c:RegisterEffect(e0)
	...
	e1:SetCondition(c75011015.spcon2)
...
function c75011015.spcon1(e,tp,eg,ep,ev,re,r,rp)
	return (Duel.IsExistingMatchingCard(c75011015.chkfilter,tp,LOCATION_MZONE,0,1,nil) or Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)==0) and Duel.GetFieldGroupCount(tp,LOCATION_ONFIELD,0)>=Duel.GetFieldGroupCount(tp,0,LOCATION_ONFIELD)
end
function c75011015.spcon2(e,tp,eg,ep,ev,re,r,rp)
	return (Duel.IsExistingMatchingCard(c75011015.chkfilter,tp,LOCATION_MZONE,0,1,nil) or Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)==0) and Duel.GetFieldGroupCount(tp,LOCATION_ONFIELD,0)<Duel.GetFieldGroupCount(tp,0,LOCATION_ONFIELD)
end
