...
function cm.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	for tc in aux.Next(sg) do
		...
		if tc:RegisterEffect(ge2,true) then tc:RegisterFlagEffect(m+0xffffff,RESET_EVENT+RESETS_STANDARD-RESET_TURN_SET,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringid(m,10)) end
	end
