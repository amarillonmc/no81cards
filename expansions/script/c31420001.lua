...
function cm.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(31420001,0))
	...
	c:RegisterEffect(e5)
	--Duel.AddCustomActivityCounter(31420001,ACTIVITY_CHAIN,cm.chainfilter)
...
function cm.negcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToHandAsCost() end-- and Duel.GetCustomActivityCount(31420001,tp,ACTIVITY_CHAIN)==0 end
