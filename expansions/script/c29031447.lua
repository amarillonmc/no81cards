--虚拟YouTuber 田中姬
function c29031447.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	...
	e2:SetCondition(c29031447.atkcon)
	...
	e3:SetCondition(c29031447.condition)
	e3:SetOperation(c29031447.operation)
	c:RegisterEffect(e3)
end
function c29031447.atkcon(e)
	local tp=e:GetHandlerPlayer()
	return Duel.GetAttackTarget()==nil and Duel.GetFieldGroupCount(tp,0,LOCATION_MZONE)>0
end
function c29031447.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetAttackTarget()==nil
end
function c29031447.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(c29031447.etlimit)
	e1:SetValue(aux.tgoval)
	e1:SetReset(RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,2)
	c:RegisterEffect(e1,true)
end
function c29031447.etlimit(e,c)
