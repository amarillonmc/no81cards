...
function c11533716.drtdtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingTarget(function(c) return c:IsFaceup() and c:IsAbleToDeck() and c:IsSetCard(0x18e,0x3a) end,tp,LOCATION_GRAVE+LOCATION_REMOVED,0,5,nil) and Duel.IsPlayerCanDraw(tp,1) end 
	local g=Duel.SelectTarget(tp,function(c) return c:IsFaceup() and c:IsAbleToDeck() and c:IsSetCard(0x18e,0x3a) end,tp,LOCATION_GRAVE+LOCATION_REMOVED,0,5,5,nil) 
