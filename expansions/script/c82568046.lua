...
function c82568046.discost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsCanRemoveCounter(tp,1,0,0x5825,1,REASON_COST) and e:GetHandler():GetLinkedGroupCount()>0 end
...
function c82568046.distg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.SelectTarget(tp,aux.disfilter1,tp,0,LOCATION_MZONE,1,e:GetHandler():GetMutualLinkedGroupCount(),nil)
