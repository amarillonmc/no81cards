...
function cm.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if g:GetFirst():IsSetCard(0x9f3d) then
...
function cm.srfilter(c)
	return c:IsSetCard(0xf3d) and c:IsType(TYPE_MONSTER) and not c:IsCode(15000781) and (c:IsAbleToHand() or c:IsAbleToGrave())
end
