...
function cm.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(90700006,1))
...
function cm.actop(e,tp,eg,ep,ev,re,r,rp)
	...
	if ffcount>=5 and Duel.IsExistingMatchingCard(cm.actfilter,tp,LOCATION_DECK,0,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(90700006,0)) then
