...
function c79029162.lzop(e,tp,eg,ep,ev,re,r,rp,chk)
	Debug.Message("各位，有何种需求？")
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029162,1))
...
function c79029162.activate(e,tp,eg,ep,ev,re,r,rp)
	Debug.Message("只要战术运用得当，我们能够打破任何艰难的局面。")
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029162,2))
