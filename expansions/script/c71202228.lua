...
function s.spfilter(c)
	return c:IsType(TYPE_TRAPMONSTER) and c:IsSetCard(0x894) and c:IsAttribute(ATTRIBUTE_WIND)
...
function s.thfilter(c)
	return c:IsSetCard(0x894) and c:IsAbleToHand()
end
