...
function c43480025.cfilter(c)
	return c:IsFacedown() or not c:IsSetCard(0x3fb3)
end
...
function c43480025.pspfil(c,e,tp) 
	return c:IsFaceup() and c:IsType(TYPE_PENDULUM) and c:IsSetCard(0x3fb3) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end 
