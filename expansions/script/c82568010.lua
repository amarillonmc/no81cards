...
function c82568010.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(82568010,1))
	e3:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_SEARCH+CATEGORY_TOHAND)
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetRange(LOCATION_MZONE)
	e3:SetCountLimit(1,82568010)
	e3:SetTarget(c82568010.target)
	e3:SetOperation(c82568010.activate)
	c:RegisterEffect(e3)
	--spsummon
...
function c82568010.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c82568010.thfilter,tp,LOCATION_GRAVE,0,0,1,nil)
	if g:GetCount()>0 then
