...
function c22021330.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(22021330,2))
	e4:SetCategory(CATEGORY_DESTROY)
	e4:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e4:SetRange(LOCATION_GRAVE)
	e4:SetProperty(EFFECT_FLAG_DELAY)
	e4:SetCountLimit(1,22021331)
	e4:SetCondition(c22021330.descon1)
	e4:SetCost(c22021330.erecost)
	e4:SetTarget(c22021330.destg)
	e4:SetOperation(c22021330.desop)
	c:RegisterEffect(e4)
end
...
function c22021330.spfilter(c,e,tp)
	return c:IsSetCard(0x6ff1) and c:IsAttackBelow(1800) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP)
end
...
function c22021330.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.Hint(HINT_CARD,0,22020980)
	Duel.PayLPCost(tp,math.floor(Duel.GetLP(tp)/2))
end
function c22021330.descon1(e,tp,eg,ep,ev,re,r,rp)
