...
function c28319111.initial_effect(c)
	...
	e0:SetDescription(aux.Stringid(28319111,0))
	c:RegisterEffect(e0)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_RECOVER+CATEGORY_TOGRAVE+CATEGORY_DECKDES)
	...
	e--2:SetCategory(CATEGORY_TODECK+CATEGORY_LEAVE_GRAVE)
