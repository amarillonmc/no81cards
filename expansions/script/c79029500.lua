--孤星壳·刃锋
function c79029500.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	...
	e1:SetCondition(c79029500.thcon)
	e1:SetTarget(c79029500.thtg)
	e1:SetOperation(c79029500.thop)  
	c:RegisterEffect(e1)
	--immune
	...
	e2:SetValue(c79029500.efilter)
	e2:SetCondition(c79029500.imcon)
	c:RegisterEffect(e2)
	--to grave
	...
	e3:SetCountLimit(1)
	e3:SetTarget(c79029500.tgtg)
	e3:SetOperation(c79029500.tgop)
	c:RegisterEffect(e3)
end
function c79029500.thcon(e,tp,eg,ep,ev,re,r,rp)
...
function c79029500.fil(c)
	return c:IsType(TYPE_FUSION)
end
function c79029500.imcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return  c:GetMaterial():IsExists(c79029500.fil,1,nil)
end
function c79029500.tgtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c79029500.tgop(e,tp,eg,ep,ev,re,r,rp) 
