--圣光禁域
function c10201002.initial_effect(c)
	--Activate
	...
	e2g:SetCondition(c10201002.gravecon)
	c:RegisterEffect(e2g)
	local e7g=e7:Clone()
	e7g:SetTargetRange(LOCATION_GRAVE,LOCATION_GRAVE)
	e7g:SetCondition(c10201002.gravecon)
	...
	e3:SetTarget(c10201002.sumlimit)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
	...
	e5:SetCondition(c10201002.gravecon)
...
function c10201002.sumlimit(e,c,tp,sumtp)
	return bit.band(sumtp,SUMMON_TYPE_ADVANCE)==SUMMON_TYPE_ADVANCE and (c:GetRace()~=RACE_FAIRY and c:GetAttribute()~=ATTRIBUTE_LIGHT)
end
function c10201002.gravecon(e)
