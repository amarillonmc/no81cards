...
function c60150518.initial_effect(c)
	...
	e3:SetCountLimit(1,60150518)
	e3:SetCost(c60150518.rmcost)
	e3:SetTarget(c60150518.thtg)
	e3:SetOperation(c60150518.rmop)
	c:RegisterEffect(e3)
	--特招
...
function c60150518.rmcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsReleasable() end
	Duel.Release(e:GetHandler(),REASON_COST)
end
function c60150518.thfilter(c)
	return c:IsSetCard(0xab20) and c:IsAbleToGrave()
end
function c60150518.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c60150518.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOGRAVE,nil,1,tp,LOCATION_DECK)
end
function c60150518.rmop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,c60150518.thfilter,tp,LOCATION_DECK,0,1,1,nil)
