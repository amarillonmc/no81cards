...
function c40009687.condition(e,c)
	...
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>0
		and not Duel.IsExistingMatchingCard(c40009687.cfilter,tp,LOCATION_MZONE,0,1,nil)
end
...
function c40009687.thfilter(c)
	return c:GetType()==TYPE_MONSTER and c:IsSetCard(0x1f17) and c:IsAbleToHand() and not c:IsCode(40009687)
end
