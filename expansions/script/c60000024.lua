...
function s.stfilter(c,tp)
	return c:IsCode(60000022,60000023) and not c:IsForbidden() and c:CheckUniqueOnField(tp)
end
...
function s.cfilter(c)
	return c:IsFaceup() and c:IsCode(60000022,60000023) and c:IsAbleToHandAsCost()
end
...
function s.cfilter2(c)
	return c:IsFaceup() and c:IsCode(60000022,60000023)
end
