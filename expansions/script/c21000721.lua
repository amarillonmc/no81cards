...
function s.target2(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b1=Duel.IsExistingMatchingCard(s.costfilter,tp,LOCATION_HAND,0,1,c)
		and Duel.IsExistingMatchingCard(s.filter2,tp,LOCATION_GRAVE,0,1,c)
	...
	local b3=Duel.IsExistingMatchingCard(s.costfilter,tp,LOCATION_ONFIELD,0,1,nil)
		and Duel.IsExistingMatchingCard(s.filter3,tp,LOCATION_GRAVE,0,1,c)
...
function s.prop2(e,tp,eg,ep,ev,re,r,rp)
	...
	if label==1 and Duel.IsExistingMatchingCard(s.filter2,tp,LOCATION_GRAVE,0,1,c) then
	...
	if label==3 and Duel.IsExistingMatchingCard(s.filter3,tp,LOCATION_GRAVE,0,1,c) then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
