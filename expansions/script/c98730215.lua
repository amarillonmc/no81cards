...
function c98730215.spfilter1(c,tp,g)
	return g:IsExists(c98730215.spfilter2,1,c,tp,c)
end
function c98730215.spfilter2(c,tp,mc)
...
function c98730215.spcon(e,c)
	...
	return g:IsExists(c98730215.spfilter1,1,nil,tp,g)
end
function c98730215.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.GetMatchingGroup(c98730215.spfilter,tp,LOCATION_HAND+LOCATION_MZONE,0,nil,c)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g1=g:FilterSelect(tp,c98730215.spfilter1,1,1,nil,tp,g)
	local mc=g1:GetFirst()
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g2=g:FilterSelect(tp,c98730215.spfilter2,1,1,mc,tp,mc)
	g1:Merge(g2)
	c:SetMaterial(g1)
