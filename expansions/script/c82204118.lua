...
function cm.atfilter(c,atk)  
	return c:IsFaceup() and c:IsSetCard(0xbb) and c:GetAttack()>atk  
end  
function cm.atlimit(e,c)  
	return c:IsFaceup() and c:IsSetCard(0xbb) and Duel.IsExistingMatchingCard(cm.atfilter,c:GetControler(),LOCATION_MZONE,0,1,nil,c:GetAttack())  
end  
