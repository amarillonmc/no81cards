...
function s.thfilter(c)
	return c:IsAbleToHand() and c:IsSetCard(0x6f52) and c:IsFaceup()
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(s.thfilter),tp,LOCATION_GRAVE+LOCATION_REMOVED,0,1,2,nil)
	if #sg>0 then
