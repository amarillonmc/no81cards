...
function cm.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(31420002,0))
	...
	e5:SetDescription(aux.Stringid(31420002,1))
	...
	c:RegisterEffect(e6)
	Duel.AddCustomActivityCounter(31420002,ACTIVITY_CHAIN,cm.chainfilter)
end
...
function cm.negcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToHandAsCost() end--and Duel.GetCustomActivityCount(31420002,tp,ACTIVITY_CHAIN)==0 end
