...
function cm.filter(c)
	return c:IsSetCard(0x3620) and c:IsType(TYPE_MONSTER) and not c:IsCode(m) and c:IsAbleToHand()
end
...
function cm.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local dg=Duel.SelectMatchingCard(tp,Card.IsType,tp,LOCATION_HAND+LOCATION_ONFIELD,0,1,1,e:GetHandler(),TYPE_MONSTER)
