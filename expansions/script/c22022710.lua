...
function c22022710.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(22022710,1))
	e5:SetCategory(CATEGORY_POSITION)
	e5:SetType(EFFECT_TYPE_IGNITION)
	e5:SetCountLimit(1,22022710)
	e5:SetRange(LOCATION_GRAVE)
	e5:SetCondition(c22022710.erecon)
	e5:SetCost(c22022710.erecost)
	e5:SetTarget(c22022710.target)
	e5:SetOperation(c22022710.operation)
	c:RegisterEffect(e5)
end
function c22022710.lvtg(e,c)
	return c:IsLevelAbove(1) and c:IsSetCard(0x6ff1)
end
...
function c22022710.erecon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsPlayerAffectedByEffect(tp,22020980)
end
function c22022710.erecost(e,tp,eg,ep,ev,re,r,rp,chk)
