...
function cm.spfilter(c,e,tp)
	return c:IsSetCard(0x6a7) and c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
...
function cm.thfilter(c)
	return c:IsSetCard(0x6a7) and c:IsAttribute(ATTRIBUTE_LIGHT) and c:IsAbleToHand()
end
