...
function c130001236.filter1(c,tp)
	...
	return lv1>0 and c:IsSetCard(0x852) and Duel.IsExistingMatchingCard(c130001236.filter2,tp,LOCATION_MZONE,0,1,c,lv1)
end
...
function c130001236.spfilter(c,e,tp)
	return c:IsSetCard(0x852) and not c:IsCode(130001236) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
