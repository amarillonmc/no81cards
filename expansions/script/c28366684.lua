...
function c28366684.initial_effect(c)
	...
	e0:SetCondition(Auxiliary.XyzLevelFreeCondition(aux.FilterBoolFunction(Card.IsSetCard,0x283),c28366684.xyzcheck,2,2))
	e0:SetTarget(Auxiliary.XyzLevelFreeTarget(aux.FilterBoolFunction(Card.IsSetCard,0x283),c28366684.xyzcheck,2,2))
	e0:SetOperation(c28366684.Operation(aux.FilterBoolFunction(Card.IsSetCard,0x283),c28366684.xyzcheck,2,2))
