...
function cm.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(aux.NOT(Card.IsForbidden),tp,LOCATION_GRAVE,LOCATION_GRAVE,1,nil) and e:GetHandler():IsType(TYPE_XYZ) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
	local g=Duel.SelectTarget(tp,aux.NOT(Card.IsForbidden),tp,LOCATION_GRAVE,LOCATION_GRAVE,1,1,nil)
