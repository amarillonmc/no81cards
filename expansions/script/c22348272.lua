...
function c22348272.actfilter(c)
	return c:IsFaceup() and c:IsCanAddCounter(0x70a3,1)
end
...
function c22348272.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:AddCounter(0x70a3,1) then
...
function c22348272.disable(e,c)
	return (c:IsType(TYPE_EFFECT) or c:GetOriginalType()&TYPE_EFFECT~=0) and c:GetCounter(0x70a3)>0
end
function c22348272.desop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Destroy(e:GetHandler(),REASON_EFFECT)
end
function c22348272.cfilter(c)
	return c:IsLocation(LOCATION_MZONE) and c:GetCounter(0x70a3)>0
end
