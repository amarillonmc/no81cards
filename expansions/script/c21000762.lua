...
function s.initial_effect(c)
	...
	e30:SetCode(EFFECT_INDESTRUCTABLE_BATTLE)
	e30:SetCondition(s.con0)
	e30:SetValue(1)
	c:RegisterEffect(e30)
	local e40=e30:Clone()
	e40:SetCode(EFFECT_INDESTRUCTABLE_EFFECT)
	e40:SetValue(aux.indoval)
	c:RegisterEffect(e40)
	local e50=e30:Clone()
	e50:SetProperty(EFFECT_FLAG_IGNORE_IMMUNE)
	e50:SetCode(EFFECT_CANNOT_BE_EFFECT_TARGET)
	e50:SetValue(aux.tgoval)
	c:RegisterEffect(e50)
	local e60=Effect.CreateEffect(c)
	e60:SetType(EFFECT_TYPE_EQUIP)
	e60:SetCode(EFFECT_UPDATE_ATTACK)
	e60:SetCondition(s.con0)
	e60:SetValue(1000)
...
function s.prop2(e,tp,eg,ep,ev,re,r,rp)
	...
	if res and e:GetHandler():IsAbleToRemove() then
