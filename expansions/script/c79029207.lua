...
function c79029207.sprop(e,tp,eg,ep,ev,re,r,rp,c)
	...
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029207,0))
end
...
function c79029207.dop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029207,1))
...
function c79029207.daop(e,tp,eg,ep,ev,re,r,rp)
	...
	e:Reset()
	Debug.Message("砰！哈哈哈——")
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029207,2))
end
...
function c79029207.d12op(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SOUND,0,aux.Stringid(79029207,3))
end
