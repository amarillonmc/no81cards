...
function s.filter1(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0xce4) and c:IsType(TYPE_XYZ)
...
function s.filter2(c,e,tp,mc,rk)
	return not c:IsRank(rk) and c:IsSetCard(0xce4) and c:IsType(TYPE_XYZ) and mc:IsCanBeXyzMaterial(c)
