...
function c98930405.initial_effect(c)
	...
	c:RegisterEffect(e1)	
	local e10=e1:Clone()
	e10:SetDescription(aux.Stringid(98930405,8))
	e10:SetRange(LOCATION_DECK)
	e10:SetCondition(c98930405.con1)
	e10:SetCost(c98930405.cost)
	...
	e30:SetTarget(c98930405.actarget)
	e30:SetOperation(c98930405.costop)
...
function c98930405.actarget(e,te,tp)
	e:SetLabelObject(te)
	return te:GetHandler()==e:GetHandler()
end
function c98930405.costop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetOperation(c98930405.rsop)
...
function c98930405.rsop(e,tp,eg,ep,ev,re,r,rp)
