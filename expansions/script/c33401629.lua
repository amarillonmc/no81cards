...
function cm.cfilter(c,tp)
	return (c:IsReason(REASON_EFFECT)or c:IsReason(REASON_BATTLE)) and c:IsType(TYPE_MONSTER) and c:IsSetCard(0x341) and c:IsType(TYPE_FUSION) and c:GetOwner()==tp
end
