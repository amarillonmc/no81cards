--六角之巅 柠
function c12524004.initial_effect(c)
 --special summon
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(12524004,0))
...
function c12524004.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c12524004.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
