...
function cm.initial_effect(c)
	...
	e1:SetCountLimit(1,15004491+EFFECT_COUNT_CODE_OATH)
...
function cm.filter2(c,e,tp,m,f,chkf,sc)
	return c:IsType(TYPE_FUSION) and (not f or f(c))
		and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_FUSION,tp,false,false) and c:CheckFusionMaterial(m,sc,chkf) and c:IsSetCard(0x5f40)
end
...
function cm.filter(c)
	return c:IsLinkSummonable(nil) and c:IsSetCard(0x5f40)
end
